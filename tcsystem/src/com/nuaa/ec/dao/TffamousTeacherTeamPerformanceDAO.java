...
/**
 	* A data access object (DAO) providing persistence and search support for TffamousTeacherTeamPerformance entities.
...
public class TffamousTeacherTeamPerformanceDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TffamousTeacherTeamPerformanceDAO.class);
		//property constants
	public static final String SINGEL_SCORE = "singelScore";
	public static final String SPARE_TIRE = "spareTire";
	public static final String CHECK_OUT = "checkOut";
	public static final String TEACHER_TEAM_PERFORMANCE_ID = "teacherTeamPerformanceId";
    ...
    public TffamousTeacherTeamPerformance findById( java.lang.Integer id) {
        log.debug("getting TffamousTeacherTeamPerformance instance with id: " + id);
        try {
    ...
    public List findByExample(TffamousTeacherTeamPerformance instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TffamousTeacherTeamPerformance")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TffamousTeacherTeamPerformance instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findByTeacherTeamPerformanceId(Object teacherTeamPerformanceId
	) {
		return findByProperty(TEACHER_TEAM_PERFORMANCE_ID, teacherTeamPerformanceId
		);
	}
    ...
    public TffamousTeacherTeamPerformance merge(TffamousTeacherTeamPerformance detachedInstance) {
