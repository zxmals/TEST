...
/**
 	* A data access object (DAO) providing persistence and search support for TfstudentCompetitionGuidanceScore entities.
...
public class TfstudentCompetitionGuidanceScoreDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfstudentCompetitionGuidanceScoreDAO.class);
		//property constants
    ...
    public TfstudentCompetitionGuidanceScore findById( java.lang.String id) {
        log.debug("getting TfstudentCompetitionGuidanceScore instance with id: " + id);
        try {
            TfstudentCompetitionGuidanceScore instance = (TfstudentCompetitionGuidanceScore) getSession()
                    .get("com.nuaa.ec.model.TfstudentCompetitionGuidanceScore", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfstudentCompetitionGuidanceScore instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfstudentCompetitionGuidanceScore")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfstudentCompetitionGuidanceScore instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfstudentCompetitionGuidanceScore merge(TfstudentCompetitionGuidanceScore detachedInstance) {
