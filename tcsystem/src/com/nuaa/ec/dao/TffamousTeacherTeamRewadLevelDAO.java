...
/**
 	* A data access object (DAO) providing persistence and search support for TffamousTeacherTeamRewadLevel entities.
...
public class TffamousTeacherTeamRewadLevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TffamousTeacherTeamRewadLevelDAO.class);
		//property constants
    ...
    public TffamousTeacherTeamRewadLevel findById( java.lang.String id) {
        log.debug("getting TffamousTeacherTeamRewadLevel instance with id: " + id);
        try {
    ...
    public List findByExample(TffamousTeacherTeamRewadLevel instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TffamousTeacherTeamRewadLevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TffamousTeacherTeamRewadLevel instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TffamousTeacherTeamRewadLevel merge(TffamousTeacherTeamRewadLevel detachedInstance) {
