...
/**
 	* A data access object (DAO) providing persistence and search support for TfclassTeachPefromance entities.
...
public class TfclassTeachPefromanceDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfclassTeachPefromanceDAO.class);
		//property constants
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfclassTeachPefromance instance with property: " + propertyName
            + ", value: " + value);
      try {
