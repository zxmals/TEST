...
/**
 	* A data access object (DAO) providing persistence and search support for TfprofessionalProjectDeclareLevel entities.
...
public class TfprofessionalProjectDeclareLevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfprofessionalProjectDeclareLevelDAO.class);
		//property constants
    ...
    public TfprofessionalProjectDeclareLevel findById( java.lang.String id) {
        log.debug("getting TfprofessionalProjectDeclareLevel instance with id: " + id);
        try {
            TfprofessionalProjectDeclareLevel instance = (TfprofessionalProjectDeclareLevel) getSession()
                    .get("com.nuaa.ec.model.TfprofessionalProjectDeclareLevel", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfprofessionalProjectDeclareLevel instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfprofessionalProjectDeclareLevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfprofessionalProjectDeclareLevel instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfprofessionalProjectDeclareLevel merge(TfprofessionalProjectDeclareLevel detachedInstance) {
