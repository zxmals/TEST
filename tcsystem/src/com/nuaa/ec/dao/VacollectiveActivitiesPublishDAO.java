...
/**
 	* A data access object (DAO) providing persistence and search support for VacollectiveActivitiesPublish entities.
...
public class VacollectiveActivitiesPublishDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(VacollectiveActivitiesPublishDAO.class);
		//property constants
    ...
    public VacollectiveActivitiesPublish findById( java.lang.String id) {
        log.debug("getting VacollectiveActivitiesPublish instance with id: " + id);
        try {
    ...
    public List findByExample(VacollectiveActivitiesPublish instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.VacollectiveActivitiesPublish")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding VacollectiveActivitiesPublish instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public VacollectiveActivitiesPublish merge(VacollectiveActivitiesPublish detachedInstance) {
