...
/**
 	* A data access object (DAO) providing persistence and search support for TftextbookConstructionTblevel entities.
...
public class TftextbookConstructionTblevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TftextbookConstructionTblevelDAO.class);
		//property constants
    ...
    public TftextbookConstructionTblevel findById( java.lang.String id) {
        log.debug("getting TftextbookConstructionTblevel instance with id: " + id);
        try {
    ...
    public List findByExample(TftextbookConstructionTblevel instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TftextbookConstructionTblevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TftextbookConstructionTblevel instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findAll() {
		...
		try {
			String queryString = "from TftextbookConstructionTblevel where spareTire=1";
	         Query queryObject = getSession().createQuery(queryString);
			 return queryObject.list();
		} catch (RuntimeException re) {
    ...
    public TftextbookConstructionTblevel merge(TftextbookConstructionTblevel detachedInstance) {
