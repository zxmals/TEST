...
/**
 	* A data access object (DAO) providing persistence and search support for TeacherLoginInfo entities.
...
public class TeacherLoginInfoDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TeacherLoginInfoDAO.class);
		//property constants
    ...
    public TeacherLoginInfo findById( java.lang.Integer id) {
        log.debug("getting TeacherLoginInfo instance with id: " + id);
        try {
            TeacherLoginInfo instance = (TeacherLoginInfo) getSession()
                    .get("com.nuaa.ec.model.TeacherLoginInfo", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TeacherLoginInfo instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TeacherLoginInfo merge(TeacherLoginInfo detachedInstance) {
        ...
        try {
            TeacherLoginInfo result = (TeacherLoginInfo) getSession()
