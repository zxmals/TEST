...
/**
 	* A data access object (DAO) providing persistence and search support for TfprofessionalProjectDeclarePerformance entities.
 ...
 */
public class TfprofessionalProjectDeclarePerformanceDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfprofessionalProjectDeclarePerformanceDAO.class);
		//property constants
	...
	public void delete(TfprofessionalProjectDeclarePerformance persistentInstance) {
    ...
    public TfprofessionalProjectDeclarePerformance findById( java.lang.Integer id) {
        log.debug("getting TfprofessionalProjectDeclarePerformance instance with id: " + id);
        try {
            TfprofessionalProjectDeclarePerformance instance = (TfprofessionalProjectDeclarePerformance) getSession()
                    .get("com.nuaa.ec.model.TfprofessionalProjectDeclarePerformance", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfprofessionalProjectDeclarePerformance instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfprofessionalProjectDeclarePerformance")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfprofessionalProjectDeclarePerformance instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfprofessionalProjectDeclarePerformance merge(TfprofessionalProjectDeclarePerformance detachedInstance) {
