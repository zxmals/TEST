...
/**
 	* A data access object (DAO) providing persistence and search support for TfenterpriseWorkstationTrainingbaseConstructionLevel entities.
 ...
 */
public class TfenterpriseWorkstationTrainingbaseConstructionLevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfenterpriseWorkstationTrainingbaseConstructionLevelDAO.class);
		//property constants
    ...
    public void save(TfenterpriseWorkstationTrainingbaseConstructionLevel transientInstance) {
	...
	public void delete(TfenterpriseWorkstationTrainingbaseConstructionLevel persistentInstance) {
    ...
    public TfenterpriseWorkstationTrainingbaseConstructionLevel findById( java.lang.String id) {
        log.debug("getting TfenterpriseWorkstationTrainingbaseConstructionLevel instance with id: " + id);
        try {
            TfenterpriseWorkstationTrainingbaseConstructionLevel instance = (TfenterpriseWorkstationTrainingbaseConstructionLevel) getSession()
                    .get("com.nuaa.ec.model.TfenterpriseWorkstationTrainingbaseConstructionLevel", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfenterpriseWorkstationTrainingbaseConstructionLevel instance) {
        log.debug("finding TfenterpriseWorkstationTrainingbaseConstructionLevel instance by example");
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfenterpriseWorkstationTrainingbaseConstructionLevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfenterpriseWorkstationTrainingbaseConstructionLevel instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfenterpriseWorkstationTrainingbaseConstructionLevel merge(TfenterpriseWorkstationTrainingbaseConstructionLevel detachedInstance) {
    ...
    public void attachDirty(TfenterpriseWorkstationTrainingbaseConstructionLevel instance) {
    ...
    public void attachClean(TfenterpriseWorkstationTrainingbaseConstructionLevel instance) {
