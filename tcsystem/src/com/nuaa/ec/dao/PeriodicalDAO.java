 ...
 * Periodical entities. Transaction control of the save(), update() and delete()
...
public class PeriodicalDAO extends BaseHibernateDAO {
	...
	public Periodical findById(java.lang.String id) {
		...
		try {
			Periodical instance = (Periodical) getSession().get(
					"com.nuaa.ec.model.Periodical", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Periodical merge(Periodical detachedInstance) {
		...
		try {
			Periodical result = (Periodical) getSession().merge(
					detachedInstance);
