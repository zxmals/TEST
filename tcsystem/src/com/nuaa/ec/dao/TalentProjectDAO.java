...
/**
 	* A data access object (DAO) providing persistence and search support for TalentProject entities.
...
public class TalentProjectDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TalentProjectDAO.class);
		//property constants
    ...
    public TalentProject findById( java.lang.String id) {
        ...
        try {
            TalentProject instance = (TalentProject) getSession()
                    .get("com.nuaa.ec.model.TalentProject", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TalentProject instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TalentProject merge(TalentProject detachedInstance) {
        ...
        try {
            TalentProject result = (TalentProject) getSession()
