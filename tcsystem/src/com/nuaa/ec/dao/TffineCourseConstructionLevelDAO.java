...
/**
 	* A data access object (DAO) providing persistence and search support for TffineCourseConstructionLevel entities.
...
public class TffineCourseConstructionLevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TffineCourseConstructionLevelDAO.class);
		//property constants
    ...
    public TffineCourseConstructionLevel findById( java.lang.String id) {
        log.debug("getting TffineCourseConstructionLevel instance with id: " + id);
        try {
    ...
    public List findByExample(TffineCourseConstructionLevel instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TffineCourseConstructionLevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TffineCourseConstructionLevel instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findAll() {
		...
		try {
			String queryString = "from TffineCourseConstructionLevel where spareTire=1";
	         Query queryObject = getSession().createQuery(queryString);
			 return queryObject.list();
		} catch (RuntimeException re) {
    ...
    public TffineCourseConstructionLevel merge(TffineCourseConstructionLevel detachedInstance) {
