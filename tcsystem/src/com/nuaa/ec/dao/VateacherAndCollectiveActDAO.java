...
/**
 	* A data access object (DAO) providing persistence and search support for VateacherAndCollectiveAct entities.
...
public class VateacherAndCollectiveActDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(VateacherAndCollectiveActDAO.class);
		//property constants
    ...
    public VateacherAndCollectiveAct findById( com.nuaa.ec.model.VateacherAndCollectiveActId id) {
    ...
    public List findByExample(VateacherAndCollectiveAct instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.VateacherAndCollectiveAct")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding VateacherAndCollectiveAct instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public VateacherAndCollectiveAct merge(VateacherAndCollectiveAct detachedInstance) {
