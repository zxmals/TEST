...
/**
 	* A data access object (DAO) providing persistence and search support for TfenterpriseWorkstationTrainingBaseConstructionPerformance entities.
 ...
 */
public class TfenterpriseWorkstationTrainingBaseConstructionPerformanceDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfenterpriseWorkstationTrainingBaseConstructionPerformanceDAO.class);
		//property constants
    ...
    public void save(TfenterpriseWorkstationTrainingBaseConstructionPerformance transientInstance) {
	...
	public void delete(TfenterpriseWorkstationTrainingBaseConstructionPerformance persistentInstance) {
    ...
    public TfenterpriseWorkstationTrainingBaseConstructionPerformance findById( java.lang.Integer id) {
        log.debug("getting TfenterpriseWorkstationTrainingBaseConstructionPerformance instance with id: " + id);
        try {
            TfenterpriseWorkstationTrainingBaseConstructionPerformance instance = (TfenterpriseWorkstationTrainingBaseConstructionPerformance) getSession()
                    .get("com.nuaa.ec.model.TfenterpriseWorkstationTrainingBaseConstructionPerformance", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfenterpriseWorkstationTrainingBaseConstructionPerformance instance) {
        log.debug("finding TfenterpriseWorkstationTrainingBaseConstructionPerformance instance by example");
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfenterpriseWorkstationTrainingBaseConstructionPerformance")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfenterpriseWorkstationTrainingBaseConstructionPerformance instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfenterpriseWorkstationTrainingBaseConstructionPerformance merge(TfenterpriseWorkstationTrainingBaseConstructionPerformance detachedInstance) {
    ...
    public void attachDirty(TfenterpriseWorkstationTrainingBaseConstructionPerformance instance) {
    ...
    public void attachClean(TfenterpriseWorkstationTrainingBaseConstructionPerformance instance) {
