 ...
 * TfteachingRearchEvaluation entities. Transaction control of the save(),
...
public class TfteachingRearchEvaluationDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TfteachingRearchEvaluationDAO.class);
	// property constants
	...
	public List findByExample(TfteachingRearchEvaluation instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.nuaa.ec.model.TfteachingRearchEvaluation")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TfteachingRearchEvaluation instance with property: "
	...
	public TfteachingRearchEvaluation merge(
			TfteachingRearchEvaluation detachedInstance) {
