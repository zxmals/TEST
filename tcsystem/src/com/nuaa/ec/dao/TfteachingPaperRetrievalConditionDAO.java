...
/**
 	* A data access object (DAO) providing persistence and search support for TfteachingPaperRetrievalCondition entities.
...
public class TfteachingPaperRetrievalConditionDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfteachingPaperRetrievalConditionDAO.class);
		//property constants
    ...
    public TfteachingPaperRetrievalCondition findById( java.lang.String id) {
        log.debug("getting TfteachingPaperRetrievalCondition instance with id: " + id);
        try {
            TfteachingPaperRetrievalCondition instance = (TfteachingPaperRetrievalCondition) getSession()
                    .get("com.nuaa.ec.model.TfteachingPaperRetrievalCondition", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TfteachingPaperRetrievalCondition instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfteachingPaperRetrievalCondition")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfteachingPaperRetrievalCondition instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfteachingPaperRetrievalCondition merge(TfteachingPaperRetrievalCondition detachedInstance) {
