 ...
 * TfteachingAchievementRewardLevel entities. Transaction control of the save(),
...
public class TfteachingAchievementRewardLevelDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TfteachingAchievementRewardLevelDAO.class);
	// property constants
	...
	public TfteachingAchievementRewardLevel findById(java.lang.String id) {
		log.debug("getting TfteachingAchievementRewardLevel instance with id: "
				+ id);
		try {
			TfteachingAchievementRewardLevel instance = (TfteachingAchievementRewardLevel) getSession()
					.get("com.nuaa.ec.model.TfteachingAchievementRewardLevel",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TfteachingAchievementRewardLevel instance) {
		...
		try {
			List results = getSession()
					.createCriteria(
							"com.nuaa.ec.model.TfteachingAchievementRewardLevel")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TfteachingAchievementRewardLevel instance with property: "
	...
	public TfteachingAchievementRewardLevel merge(
			TfteachingAchievementRewardLevel detachedInstance) {
