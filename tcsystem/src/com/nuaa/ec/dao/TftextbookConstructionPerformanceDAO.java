...
/**
 	* A data access object (DAO) providing persistence and search support for TftextbookConstructionPerformance entities.
...
public class TftextbookConstructionPerformanceDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TftextbookConstructionPerformanceDAO.class);
		//property constants
    ...
    public TftextbookConstructionPerformance findById( java.lang.Integer id) {
        log.debug("getting TftextbookConstructionPerformance instance with id: " + id);
        try {
            TftextbookConstructionPerformance instance = (TftextbookConstructionPerformance) getSession()
                    .get("com.nuaa.ec.model.TftextbookConstructionPerformance", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TftextbookConstructionPerformance instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TftextbookConstructionPerformance")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TftextbookConstructionPerformance instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TftextbookConstructionPerformance merge(TftextbookConstructionPerformance detachedInstance) {
