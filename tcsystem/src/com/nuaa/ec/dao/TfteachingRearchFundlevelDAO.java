...
/**
 	* A data access object (DAO) providing persistence and search support for TfteachingRearchFundlevel entities.
...
public class TfteachingRearchFundlevelDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TfteachingRearchFundlevelDAO.class);
		//property constants
    ...
    public List findByExample(TfteachingRearchFundlevel instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.nuaa.ec.model.TfteachingRearchFundlevel")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TfteachingRearchFundlevel instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TfteachingRearchFundlevel merge(TfteachingRearchFundlevel detachedInstance) {
