...
public class VateacherAndCollectiveActId  implements java.io.Serializable {
    ...
    /** full constructor */
    public VateacherAndCollectiveActId(VacollectiveActivitiesPublish vacollectiveActivitiesPublish, Teacher teacher) {
    ...
    public void setVacollectiveActivitiesPublish(VacollectiveActivitiesPublish vacollectiveActivitiesPublish) {
        this.vacollectiveActivitiesPublish = vacollectiveActivitiesPublish;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VateacherAndCollectiveActId) ) return false;
		 VateacherAndCollectiveActId castOther = ( VateacherAndCollectiveActId ) other; 
         
		 return ( (this.getVacollectiveActivitiesPublish()==castOther.getVacollectiveActivitiesPublish()) || ( this.getVacollectiveActivitiesPublish()!=null && castOther.getVacollectiveActivitiesPublish()!=null && this.getVacollectiveActivitiesPublish().equals(castOther.getVacollectiveActivitiesPublish()) ) )
 && ( (this.getTeacher()==castOther.getTeacher()) || ( this.getTeacher()!=null && castOther.getTeacher()!=null && this.getTeacher().equals(castOther.getTeacher()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getVacollectiveActivitiesPublish() == null ? 0 : this.getVacollectiveActivitiesPublish().hashCode() );
