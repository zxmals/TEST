...
//	private Integer teacherprimaryid;
	...
	private Set tfsummerCourseInternationalConstructionPerformances = new HashSet(
			0);
...
//		this.teacherprimaryid = teacherprimaryid;
	...
	public Teacher(String teacherId, ResearchLab researchLab,
			Department department, String spareTire, String teacherName,
			String departAdmin, String researchLabAdmin, String vaadmin,
			 String teacherPost,
			Set teacherAndinvitedExpertsSpeechs,
			Set tfprofessionalProjectDeclarePerformances,
			Set tfstudentCompetitionGuidancePerformances,
			Set teacherAndperiodicals, Set tfteachingCompetitionPerformances,
			Set tfdegreeThesisGuidancePerformances,
			Set tfsummerCourseInternationalConstructionPerformances,
			Set tftextbookConstructionPerformances,
			Set teacherAndmainUndertakeAcademicMeetings,
			Set tfteachingPaperPerformances,
			Set tfteachingAbilityImprovePerformances,
			...
			Set tfclassTeachPefromances, Set tfjoinStudentActivityPerformances,
			Set tfundergraduateTutorGuidancePerformances,
			Set tfpracticeInnovationGuidePerformances,
			Set tfteachingRearchPerformances, Set vateacherAndCollectiveActs,
			Set teacherAndjoinAcademicMeetings, Set vacollectiveActs,
			Set tfteachingAchievementPerformances, Set teacherLoginInfos,
			Set teacherAndscientificResearchRewards,
			Set teacherAndacademicWorks, Set tffamousTeacherTeamPerformances) {
		this.teacherId = teacherId;
...
//	}
	...
	public void setTeacherAndinvitedExpertsSpeechs(
			Set teacherAndinvitedExpertsSpeechs) {
		this.teacherAndinvitedExpertsSpeechs = teacherAndinvitedExpertsSpeechs;
	}
	...
	public void setTfstudentCompetitionGuidancePerformances(
			Set tfstudentCompetitionGuidancePerformances) {
		this.tfstudentCompetitionGuidancePerformances = tfstudentCompetitionGuidancePerformances;
	}
	...
	public void setTfteachingCompetitionPerformances(
			Set tfteachingCompetitionPerformances) {
		this.tfteachingCompetitionPerformances = tfteachingCompetitionPerformances;
	}
	...
	public void setTfdegreeThesisGuidancePerformances(
			Set tfdegreeThesisGuidancePerformances) {
		this.tfdegreeThesisGuidancePerformances = tfdegreeThesisGuidancePerformances;
	}
	...
	public void setTfsummerCourseInternationalConstructionPerformances(
			Set tfsummerCourseInternationalConstructionPerformances) {
		this.tfsummerCourseInternationalConstructionPerformances = tfsummerCourseInternationalConstructionPerformances;
	}
	...
	public void setTeacherAndmainUndertakeAcademicMeetings(
			Set teacherAndmainUndertakeAcademicMeetings) {
		this.teacherAndmainUndertakeAcademicMeetings = teacherAndmainUndertakeAcademicMeetings;
	}
	...
	public void setTfteachingAbilityImprovePerformances(
			Set tfteachingAbilityImprovePerformances) {
		this.tfteachingAbilityImprovePerformances = tfteachingAbilityImprovePerformances;
	}
	...
	public void setTeacherAndselectedTalentProjects(
			Set teacherAndselectedTalentProjects) {
		this.teacherAndselectedTalentProjects = teacherAndselectedTalentProjects;
	}
	...
	public void setTfjoinStudentActivityPerformances(
			Set tfjoinStudentActivityPerformances) {
		this.tfjoinStudentActivityPerformances = tfjoinStudentActivityPerformances;
	}
	...
	public void setTfundergraduateTutorGuidancePerformances(
			Set tfundergraduateTutorGuidancePerformances) {
		this.tfundergraduateTutorGuidancePerformances = tfundergraduateTutorGuidancePerformances;
	}
	...
	public void setTfpracticeInnovationGuidePerformances(
			Set tfpracticeInnovationGuidePerformances) {
		this.tfpracticeInnovationGuidePerformances = tfpracticeInnovationGuidePerformances;
	}
	...
	public void setTeacherAndscientificResearchRewards(
			Set teacherAndscientificResearchRewards) {
		this.teacherAndscientificResearchRewards = teacherAndscientificResearchRewards;
	}
