...
public class TfprofessionalProjectDeclareLevel implements java.io.Serializable {
	...
	private Set tfprofessionalProjectDeclareProjects = new HashSet(0);
	...
	/** full constructor */
	public TfprofessionalProjectDeclareLevel(String projectLevelId,
			String projectLevel, Double score, String spareTire,
			String reformResearchId, Set tfprofessionalProjectDeclareProjects) {
		this.projectLevelId = projectLevelId;
		this.projectLevel = projectLevel;
		this.score = score;
		this.spareTire = spareTire;
		this.reformResearchId = reformResearchId;
		this.tfprofessionalProjectDeclareProjects = tfprofessionalProjectDeclareProjects;
	}
	...
	public Set getTfprofessionalProjectDeclareProjects() {
		return this.tfprofessionalProjectDeclareProjects;
	}

	public void setTfprofessionalProjectDeclareProjects(
			Set tfprofessionalProjectDeclareProjects) {
		this.tfprofessionalProjectDeclareProjects = tfprofessionalProjectDeclareProjects;
	}
