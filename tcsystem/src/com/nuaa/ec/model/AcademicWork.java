...
public class AcademicWork implements java.io.Serializable {
	...
	/** full constructor */
	// public AcademicWork(String acaworkId, PublishClub publishClub, String
	// firstAuthor, String workName, String publishDate, String isbn, String
	// wordNumber, String otherAuthorJoin, String spareTire, String wordId,
	// String chargePersonId, String chargePerson, String checkout, Set
	// teacherAndacademicWorks) {
	// this.acaworkId = acaworkId;
	// this.publishClub = publishClub;
	// this.firstAuthor = firstAuthor;
	// this.workName = workName;
