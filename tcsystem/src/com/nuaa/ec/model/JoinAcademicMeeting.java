...
public class JoinAcademicMeeting  implements java.io.Serializable {
    ...
    /** full constructor */
    public JoinAcademicMeeting(String joinAcaMid, MeetingPlace meetingPlace, MeetingType meetingType, String acaMeetName, String spareTire, String chargePersonId, String chargePerson, String checkout, String meetingdate, Set teacherAndjoinAcademicMeetings) {
        this.joinAcaMid = joinAcaMid;
