...
public class ScientificResearchProject  implements java.io.Serializable {
    ...
    /** full constructor */
    public ScientificResearchProject(String srprojectId, ProjectType projectType, String srpname, String chargePerson, String projectNumber, String projectSource, String admitedProjectYear, String sumFunds, String spareTire, String chargePersonId, String checkout, Set teacherAndscientificResearchProjects) {
        this.srprojectId = srprojectId;
