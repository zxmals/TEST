...
public class TftextbookConstructionTblevel implements java.io.Serializable {
	...
	private Set tftextbookConstructionProjects = new HashSet(0);
	...
	/** full constructor */
	public TftextbookConstructionTblevel(String tblevelId, String tblevel,
			Double score, String reformResearchId, String spareTire,
			Set tftextbookConstructionProjects) {
		this.tblevelId = tblevelId;
		this.tblevel = tblevel;
		this.score = score;
		this.reformResearchId = reformResearchId;
		this.spareTire = spareTire;
		this.tftextbookConstructionProjects = tftextbookConstructionProjects;
	}
	...
	public Set getTftextbookConstructionProjects() {
		return this.tftextbookConstructionProjects;
	}

	public void setTftextbookConstructionProjects(
			Set tftextbookConstructionProjects) {
		this.tftextbookConstructionProjects = tftextbookConstructionProjects;
	}
