...
public class TermSetAction extends ActionSupport implements RequestAware {
	 ...
	 * 数据传值对象
	 */
	private Tfterm entity;
	private TftermDAO entityDao = new TftermDAO();
	...
	public String addEntity() throws Exception {
		...
		try {
			...
			entity.setTermId(pkmk.mkpk(
					EntityUtil.getPkColumnName(Tfterm.class),
					EntityUtil.getTableName(Tfterm.class), "TFfund"));
	...
	public Tfterm getEntity() {
		return entity;
	}

	public void setEntity(Tfterm entity) {
		this.entity = entity;
	}
