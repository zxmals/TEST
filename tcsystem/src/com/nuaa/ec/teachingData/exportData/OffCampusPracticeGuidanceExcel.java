...
public class OffCampusPracticeGuidanceExcel {
	...
	public static HSSFWorkbook  generateExcel(String[] ths,List<TfoffCampusPracticeGuidancePerformanceUnionTfterm> tfOffCampusPracGuidList,String researchLabName,String foredate,String afterdate){
...
//  合并单元格  org.apache.poi.hssf.util.Region(short rowFrom,short colFrom,short rowTo,short colTo)
		...
		cells[0].setCellValue("校外实践指导["+researchLabName+"]");
		//应用格式
		...
		if(tfOffCampusPracGuidList!=null){
			for(int i=0;i<tfOffCampusPracGuidList.size();i++){
...
/**
 * 导出字段：
 * {"指导项目编号","指导项目名称","项目类型","单位数量","数量30'/个","实习时长（2'/2h）","当前教师工号","当前教师姓名","教师绩效"};
 */
				cell[0].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getOffguidanceId());
				cell[0].setCellStyle(cellStyle);
				cell[1].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getProjectName());
				cell[1].setCellStyle(cellStyle);
				cell[2].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getTfoffCampusPracticeGuidanceLevel().getProjectType());
				cell[2].setCellStyle(cellStyle);
				cell[3].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getTfoffCampusPracticeGuidanceLevel().getUnit());
				cell[3].setCellStyle(cellStyle);
				cell[4].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getQuantityUnit());
				cell[4].setCellStyle(cellStyle);
				cell[5].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getSumhours());
				cell[5].setCellStyle(cellStyle);
				cell[6].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getTeacher().getTeacherId());
				cell[6].setCellStyle(cellStyle);
				cell[7].setCellValue(tfOffCampusPracGuidList.get(i).getOffCampusPracticeGuidancePerformance().getTeacher().getTeacherName());
