...
<html lang="zh-CN">
  ...
  <base target="_self"> 
    ...
    <title>JoinAcademicMeeting--Place --Set</title>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>参加学术会议设置 --会议地点设置<small></small></h5>
                    ...
                    <div class="">
                       ...
                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
								<c:forEach var="ebj"  items="${meetingplaceli }">
								<tr>
									<td>${ebj.meetingPlaceId }</td>
									<td>${ebj.meetingPlace }</td>
