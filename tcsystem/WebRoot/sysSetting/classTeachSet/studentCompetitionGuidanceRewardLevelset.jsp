...
<body class="gray-bg" onload="DoCheck()">
    ...
    $('#subupdate').click(function() {
		if($('#upinfscope').val().trim()!=""){//$('#upinf').val().trim()!=""
			$.post("ATstudentCompetitionGuidanceRewardLevelset!updateEntity",
					{"entity.rewardLevelId":$('#upinfID').val().trim(),
					 "entity.rewardLevel":$('#upinfscope').val().trim()
					...
					function(data,status){
						if(status=="success"){
							if(data.trim()=="succ"){
								...
								window.location.replace("ATstudentCompetitionGuidanceRewardLevelset!entityList");
							}else{
	...
	$('.delinf').click(function() {
		var row = $(this).parent().parent();
		 swal({
			...
			function(isConfirm){
			  if (isConfirm) {
				  $.post("ATstudentCompetitionGuidanceRewardLevelset!deleteEntity",
							{"entity.rewardLevelId":row[0].cells[0].innerHTML,
							 "entity.rewardLevel":row[0].cells[1].innerHTML},
							function(data,status){
								if(status=="success"){
									if(data.trim()=="succ"){
    ...
    $('.openupdatem').click(function() {
		...
		//$('#upinfratio').attr("value",$(this).parent().parent()[0].cells[2].innerHTML);
