...
<body class="gray-bg" onload="DoCheck()">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="form-group">
								<label>方式:</label> <input id="upinfscope" type="text"
									class="form-control nullcheck" name="" value="">
							</div>
							<div class="form-group">
								<label>单位:</label> <input id="upinfunit" type="text"
									class="form-control nullcheck" name="" value="">
							</div>
							<div class="form-group">
								<label>分数:</label> <input id="upinfratio" type="text"
									class="form-control nullcheck" name="" value="">
							</div>
							<div>
								<button type="button"
					...
					<div class="modal-body">
						<div class="row">
							...
							<form role="form" id="onlyForm" name="adds"
								action="AToffCampusPracticeGuidanceLevelset!addEntity" method="post">
								<div class="form-group">
									<label>方式:</label> <input id="addinf1" type="text"
										class="form-control nullcheck" name="entity.projectType"
										value="">
								</div>
								<div class="form-group">
									<label>单位:</label> <input id="addinf2" type="text"
										class="form-control nullcheck" name="entity.unit"
										value="">
								</div>
								<div class="form-group">
									<label>分数:</label> <input id="addinf3" type="text"
    ...
    $('#subupdate').click(function() {
		if($('#upinfscope').val().trim()!=""){//$('#upinfscope').val().trim()!=""
			$.post("AToffCampusPracticeGuidanceLevelset!updateEntity",
					{"entity.projectId":$('#upinfID').val().trim(),
					 "entity.projectType":$('#upinfscope').val().trim(),
					 "entity.unit":$('#upinfunit').val().trim(),
					 "entity.score":$('#upinfratio').val().trim()},
					function(data,status){
						if(status=="success"){
							if(data.trim()=="succ"){
								swal("Good job!","更新成功","success");
								window.location.replace("AToffCampusPracticeGuidanceLevelset!entityList");
							}else{
	...
	$('.delinf').click(function() {
		var row = $(this).parent().parent();
		 swal({
			...
			function(isConfirm){
			  if (isConfirm) {
				  $.post("AToffCampusPracticeGuidanceLevelset!deleteEntity",
							{"entity.projectId":row[0].cells[0].innerHTML,
							 "entity.projectType":row[0].cells[1].innerHTML,
							 "entity.unit":row[0].cells[2].innerHTML,
							 "entity.score":row[0].cells[3].innerHTML},
							function(data,status){
								if(status=="success"){
									if(data.trim()=="succ"){
    ...
    $('.openupdatem').click(function() {
		...
		$('#upinfunit')[0].value=$(this).parent().parent()[0].cells[2].innerHTML;
