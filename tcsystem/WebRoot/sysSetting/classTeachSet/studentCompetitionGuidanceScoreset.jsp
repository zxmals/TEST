...
<body class="gray-bg" onload="DoCheck()">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="form-group">
								<label>基础分数:</label> <input id="upinfscope" type="text"
					...
					<div class="modal-body">
						<div class="row">
							...
							<form role="form" id="onlyForm" name="adds"
								action="ATstudentCompetitionGuidanceScoreset!addEntity" method="post">
								<div class="form-group">
									<label>基础分数:</label> <input id="addinf1" type="text"
										class="form-control nullcheck" name="entity.baseScore"
										value="">
								</div>
							</form>
							<div>
    ...
    $('#subupdate').click(function() {
		if($('#upinfscope').val().trim()!=""){//$('#upinfscope').val().trim()!=""
			$.post("ATstudentCompetitionGuidanceScoreset!updateEntity",
					{"entity.scguidaceScoreId":$('#upinfID').val().trim(),
					 "entity.baseScore":$('#upinfscope').val().trim()
					...
					function(data,status){
						if(status=="success"){
							if(data.trim()=="succ"){
								...
								window.location.replace("ATstudentCompetitionGuidanceScoreset!entityList");
							}else{
	...
	$('.delinf').click(function() {
		var row = $(this).parent().parent();
		 swal({
			...
			function(isConfirm){
			  if (isConfirm) {
				  $.post("ATstudentCompetitionGuidanceScoreset!deleteEntity",
							{"entity.scguidaceScoreId":row[0].cells[0].innerHTML,
							 "entity.baseScore":row[0].cells[1].innerHTML},
							function(data,status){
								if(status=="success"){
									if(data.trim()=="succ"){
