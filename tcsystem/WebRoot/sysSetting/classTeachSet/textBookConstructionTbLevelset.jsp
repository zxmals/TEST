...
<body class="gray-bg" onload="DoCheck()">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="form-group">
								<label>教材等级:</label> <input id="upinfscope" type="text"
					...
					<div class="modal-body">
						<div class="row">
							...
							<form role="form" id="onlyForm" name="adds"
								action="ATtextBookConstructionTbLevelset!addEntity" method="post">
								<div class="form-group">
									<label>等级:</label> <input id="addinf1" type="text"
										class="form-control nullcheck" name="entity.tblevel"
										value="">
								</div>
								<div class="form-group">
    ...
    $('#subupdate').click(function() {
		if($('#upinfscope').val().trim()!=""){
			$.post("ATtextBookConstructionTbLevelset!updateEntity",
					{"entity.tblevelId":$('#upinfID').val().trim(),
					 "entity.tblevel":$('#upinfscope').val().trim(),
					 "entity.score":$('#upinfratio').val().trim()},
					function(data,status){
						if(status=="success"){
							if(data.trim()=="succ"){
								swal("Good job!","更新成功","success");
								window.location.replace("ATtextBookConstructionTbLevelset!entityList");
							}else{
	...
	$('.delinf').click(function() {
		 ...
		 swal({
			...
			function(isConfirm){
			  if (isConfirm) {
				  $.post("ATtextBookConstructionTbLevelset!deleteEntity",
							{"entity.tblevelId":row[0].cells[0].innerHTML,
							 "entity.tblevel":row[0].cells[1].innerHTML,
