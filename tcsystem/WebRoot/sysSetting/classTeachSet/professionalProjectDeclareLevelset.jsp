...
<body class="gray-bg" onload="DoCheck()">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="form-group">
								<label>专业等级:</label> <input id="upinfscope" type="text"
					...
					<div class="modal-body">
						<div class="row">
							...
							<form role="form" id="onlyForm" name="adds"
								action="ATprofessionalProjectDeclareLevelset!addEntity" method="post">
								<div class="form-group">
									<label>专业等级:</label> <input id="addinf1" type="text"
    ...
    $('#subupdate').click(function() {
		if($('#upinfscope').val().trim()!=""){
			$.post("ATprofessionalProjectDeclareLevelset!updateEntity",
					...
					function(data,status){
						if(status=="success"){
							if(data.trim()=="succ"){
								...
								window.location.replace("ATprofessionalProjectDeclareLevelset!entityList");
							}else{
	...
	$('.delinf').click(function() {
		 ...
		 swal({
			...
			function(isConfirm){
			  if (isConfirm) {
					$.post("ATprofessionalProjectDeclareLevelset!deleteEntity",
