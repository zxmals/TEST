...
<html lang="zh-CN">
  ...
  <base target="_self"> 
    ...
    <title>ProjectRewardLevel --Set</title>
...
<body class="gray-bg"  onload="DoCheck()">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>科研奖励设置 --奖励级别设置<small></small></h5>
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog"     aria-labelledby="myModalLabel">
                    ...
                    <div class="row">
                            <h3 class="m-t-none m-b">修改</h3>
                                <div class="form-group"  style="display: none">
                                	<label>ID:</label>                                	
									<input id="upinfID" type="text"  class="form-control" name="word.wordID" value=""  readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label>奖励级别:</label>
                                    <input id="upinf" type="text"  class="form-control nullcheck" name="word.wordNumber" value="">
                                </div>                                                           
                                <div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" id="onlyForm" name="adds"action="ATProjectRewardLevelset!addProjectRewardLevel" method="post">                            
                                <div class="form-group">                                
                                    <label>奖励级别:</label>
                                    <input id="addinf" type="text"  class="form-control nullcheck" name="rewardlev.rewardLevelName" value="">
                                </div>                                                           
                            </form>
                                <div>
                                    <button type="button"   class="btn btn-outline btn-primary pull-right m-t-n-xs" data-dismiss="modal">关闭</button>
    ...
    $('#subupdate').click(function() {
		if($('#upinf').val().trim()!=""){
			$.post("ATProjectRewardLevelset!updateProjectRewardLevel",
					{"rewardlev.rewardLevelName":$('#upinf').val().trim(),
					 "rewardlev.rewardLevelId":$('#upinfID').val().trim()},
					function(data,status){
						if(status=="success"){
							if(data=="succ"){
								alert("更新成功");
								window.location.replace("ATProjectRewardLevelset!getProjectRewardLevelINF");
							}else{
								alert("操作失败");
							}
						}else{
    ...
    $('.delinf').click(function() {
		...
		if(x){
			$.post("ATProjectRewardLevelset!deleteProjectRewardLevel",
					{"rewardlev.rewardLevelName":row[0].cells[1].innerHTML,
					 "rewardlev.rewardLevelId":row[0].cells[0].innerHTML},
					function(data,status){
						if(status=="success"){
							if(data=="succ"){
								alert("删除成功");
