				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content" style="height:540px;">
							...
							<div>
								<form name="vatest"
									action="ATlookatEveryActIFRAME!lookateveryAct" method="post">
									<p>导出活动列表</p>
									<a>[时间范围]&nbsp;&nbsp;从:<input type="text" id="date1"
										class="Wdate" onClick="WdatePicker()" value="${foredate }"
										name="foredate"
										style="width:120px;height:25px;border-radius:3px;" /> 到:<input
										type="text" id="date2" onClick="WdatePicker()"
										class="Wdate addcheck nullcheck" value="${afterdate }"
										name="afterdate"
										style="width:120px;height:25px;border-radius:3px;" />
										&nbsp;&nbsp;
									</a> <a>[系]: <select
										style="width:120px;height:25px;border-radius:3px;"
										name="departmentId" id="departmentId"
										class="addcheck nullcheck">
											<option selected="selected" value=""></option>
											<c:forEach var="department" items="${departmentList }">
												<option value="${department.departmentId }">${department.departmentName }</option>
											</c:forEach>
									</select></a>&nbsp;&nbsp;&nbsp;&nbsp; <a> [活动类型]:<select
										style="width:120px;height:25px;border-radius:3px;"
										id="vaacttype" name="vaacttype" class="addcheck nullcheck">
											<option selected="selected" value=""></option>
									...
									<button class="btn btn-primary" type="submit" id="searchvaList"
										data-backdrop="true">
										<strong>查找活动</strong>
									</button>
									<button class="btn btn-primary" type="submit"
										id="vaListexports" data-backdrop="true">
