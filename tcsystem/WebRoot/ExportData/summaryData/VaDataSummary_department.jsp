	                         ...
	                         <div>
	                         	<form name="sumf" action="ATVaActDataSummary_departmentIframe!getVaSummaryDataaaByDepartment" method="post">
	                         		<a>[日期范围]&nbsp;&nbsp;从:
										...
										&nbsp;&nbsp;</a>
			                    	<a>[系]:
				                    	<select style="width:120px;height:25px;border-radius:3px;" id="departmentId" name="departmentId" class="addcheck nullcheck" >
				                    			<option selected="selected" value=""></option>
												<c:forEach var="department" items="${departmentList }">
													<option value="${department.departmentId }">${department.departmentName }</option>
												</c:forEach>
												<option value="allDepartment">所有系</option>
										</select></a>&nbsp;&nbsp;&nbsp;&nbsp;
