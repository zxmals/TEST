...
<html lang="zh-CN">
  ...
  <base target="_self"> 
    ...
    <script type="text/javascript">
    	...
    	var departId = "${depart.departmentId}";
    	var foreterm = "${foreterm}";
    	var afterterm = "${afterterm}";
    </script>
</head>
...
<!-- 	                         </button> -->
	                    <br>
	                       ...
	                       <table id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                            ...
	                            <tbody>
									<c:forEach var="ebj" items="${teachersum }">
										<tr>
											<td title="${ebj.teacher.teacherId }">${ebj.teacher.teacherName }</td>
    ...
    $('.exportsumd').click(function() {
		swal("正在导出 . . . ");
		window.location.replace("ATTeachingDataSUM_departview!exportData?foreterm="+foreterm+"&afterterm="+afterterm+"&depart.departmentId="+departId);
	});
    </script>
