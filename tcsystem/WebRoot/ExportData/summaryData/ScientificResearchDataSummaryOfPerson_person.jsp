...
<!-- 											</c:forEach> -->
<!-- 										</select> -->
										<input type="date" style="width:120px;height:25px;border-radius:3px;border:1px solid silver;" id="date1" class="addcheck nullcheck" name="foredate">									
										到:
<!-- 										<select style="width:120px;height:25px;border-radius:3px;" id="date2" class="addcheck nullcheck" name="afterdate"> -->
<!-- 											<option selected="selected"></option> -->
<!-- 											<c:forEach var="term" items="${termList }"> -->
<!-- 												<option value="${term.termId }">${term.term }</option> -->
<!-- 											</c:forEach> -->
<!-- 										</select>									 -->
										<input type="date" style="width:120px;height:25px;border-radius:3px;border:1px solid silver;" id="date2" class="addcheck nullcheck" name="afterdate">
										&nbsp;&nbsp;</a>
			                    	<a>[请输入教师工号：]:
<!-- 				                    	<select style="width:120px;height:25px;border-radius:3px;" id="researchLabId" name="researchLabId" class="addcheck nullcheck" > -->
...
<!-- 												</c:forEach> -->
<!-- 												<option value="allResearchLab">所有研究所</option> -->
<!-- 										</select> -->
