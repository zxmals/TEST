...
<script src="../../js/bootstrap.min.js?v=3.3.5" type="text/javascript"></script>
...
<script src="../../js/plugins/iCheck/icheck.min.js"
	type="text/javascript"></script>
<script src="../../js/PublicCheck/PUB_SET.js" type="text/javascript"></script>
<!-- ISBN输入控制 -->
...
<body class="gray-bg">
	<div class="ibox-content" style="height: 540px;">
		...
		<br>
		<!--  -->
		<div id="dataDiv" class="modal fade" aria-hidden="true" tabindex="-1"
...
<!-- 							<h3 id="tableCaption" style="text-align: center;">无对应记录...</h3> -->
			 		               <h3 class="m-t-none m-b" id="updatemodaldialogTitle">${sessionScope.modulename_summary }</h3> 
							<table id="dataTable" border="1px"
								style="cellspacing: 0px; cellpadding: 0px; width: 1050px; margin: 0 auto; font-size: 11px;"
				...
				<tbody>
					<c:forEach var="entity" items="${vaActSummaryDateByPerson }">
						<tr>
							...
							<td><a
								onclick="showDetail('${entity.teacherId }','joinedActData');"
								data-backdrop="true" data-target="#dataDiv" data-toggle="modal">${entity.teacherJoinedData.sum }/${entity.teacherJoinedData.average }</a></td>
							<td><a
								onclick="showDetail('${entity.teacherId }','unjoinedActData');"
								data-backdrop="true" data-target="#dataDiv" data-toggle="modal">${entity.unjoinedActData.sum }/${entity.unjoinedActData.average }</a></td>
	...
	<script type="text/javascript">
		...
		function showDetail(teacherId, moduleName) {
			...
			$.post("ATVaActDataSummary_teacherIframe!getDetailDataInfoJson", {
				...
				foredate : '${sessionScope.foredate_summary1}',
				afterdate : '${sessionScope.afterdate_summary1}'
