	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<input type="button" value="生成科研审核数据" onclick="makeitdata('1')">&nbsp;&nbsp;<input
					type="button" value="生成教学审核数据" onclick="makeitdata('2')"><br />
				DataExport. <br>
    			...
    			for(int i=0;i<derlist.size();i++) {%>
						<tr>
							<td><input type="submit"
								onclick="javascript:document.f.action='download?filename=<%=derlist.get(i).getFileName() %>.xls';document.f.submit();"
								value="<%=derlist.get(i).getFileName() %>.xls（点击下载）"
								style="background-color:white ;color:#5599FF"></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;<%=derlist.get(i).getExportDate() %>
							</td>
						</tr>
						<%} %>
					</table>
