...
<body class="gray-bg"  onload="DoCheck()">
	                ...
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <button class="btn  btn-primary openaddm" type="submit" data-backdrop="true" data-toggle="modal" data-target="#utdialog">
	                        	 <strong>新增教材建设</strong>
	                         </button><br><br>
	                    <form id="adjusts" action="GTteachingtextbookPerformanceSet-project!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingtextbookPerformanceSet-project!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingtextbookPerformanceSet-project!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingtextbookPerformanceSet-project!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingtextbookPerformanceSet-project!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
		...
		if(checkadds()){
			swal({   
	    		...
	    		closeOnCancel: true }, 
	    			function(isConfirm){   
	    				if (isConfirm) {
	    					$.post("GTteachingtextbookPerformanceSet-project!addProject",
	    							...
	    							function(data,status){
	    								 if(status=="success"){
	    									 if(data=="succ"){
	    										 swal("添加成功","","success");
	    	    								 setTimeout(function() {
	    	    									 window.location.replace("GTteachingtextbookPerformanceSet-project!gainAllProject?pagenum=1");
	    										}, 2000);
	    									 }else{
	    										 swal("成功","","warning");
	    									 }
    	...
    	if(checkadds()&&projectId!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("GTteachingtextbookPerformanceSet-project!updateProject",
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("GTteachingtextbookPerformanceSet-project!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		$.post("GTteachingtextbookPerformanceSet-project!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("GTteachingtextbookPerformanceSet-project!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "textbookproject.bookId":projectId},
		function(data,status){
    ...
    $('.joinProj').click(function(e) {
		...
		swal({
    		...
    		function(isConfirm){
    			if(isConfirm){
    				$.post("GTteachingtextbookPerformanceSet-project!joinPeoject",
