					...
					<div class="ibox-content">
						...
						<div class="example">
									...
									<tbody>
										<c:forEach var="degreeThesisGuidancePerf"
											...
											<tr>
												...
												<!-- 操作 -->
												<td><a class="btn btn-primary btn-sm quitpaper">修改</a>
													<a class="btn btn-primary btn-sm quitpaper">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
							...
							<div style="text-align: center;">
								(共查询到${sumrow }记录)&nbsp;&nbsp;&nbsp;&nbsp; 第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
								<a class="comphref"
									href="GTacademicwork-personset!getPersonJoin?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
								<a class="comphref"
									href="GTacademicwork-personset!getPersonJoin?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
								<a class="comphref"
									href="GTacademicwork-personset!getPersonJoin?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
								<a class="comphref"
									href="GTacademicwork-personset!getPersonJoin?pagenum=${sumpage }">尾页</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="form-group">
								<label>ID:</label> <input id="upSRPTypeId" type="text"
									class="form-control" name="upProType.projectTypeId" value=""
									readonly="readonly">
							</div>
							<div class="form-group">
								<label>科研项目名称:</label> <input id="upSRPTypeName" type="text"
									class="form-control nullcheck" name="upProType.projectTpName"
									value="">
							</div>
							<div>
								<button type="button"
						...
						<div class="row">
							...
							<form role="form" id="onlyForm" name="adds"
								...
								<div class="form-group" style="display: none;">
									<label>ID</label>&nbsp;<label></label> <input id="SRPTypeName"
										type="text" class="form-control nullcheck" name="" value="">
								</div>
								<div class="form-group">
									<label>姓名</label>&nbsp;<label></label> <input id="teacherName"
										type="text" class="form-control nullcheck"
										name="degreeThesisGuidancePerformance.teacher.teacherName"
										value="">
								</div>
								<div class="form-group">
									<label>工号:</label>&nbsp;<label></label> <input id="teacherId"
										type="text" class="form-control nullcheck"
										name="degreeThesisGuidancePerformance.teacher.teacherId"
										value="">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>奖励级别:</label>&nbsp;<label></label> <select
										id="rewardLevel" class="form-control nullcheck"
										name="degreeThesisGuidancePerformance.tfdegreeThesisGuidanceRewardLevel.rewardLevelId">
					...
					.click(
							function() {
								$('#upSRPTypeId')
										.attr(
												"value",
												$(this).parent().parent()[0].cells[0].innerHTML);
								$('#upSRPTypeName')[0].value = $(this).parent()
					...
					.click(
							function() {
								...
								if (x) {
									$
											.post(
													"ATScientificResearchProjectTypeset!delProjectType",
													{
