...
<html lang="zh-CN">
  ...
  <base target="_self"> 
    ...
    <title>TFfinecourse --Personal-Set</title>
...
<body class="gray-bg"  onload="DoCheck()">
	        ...
	        <div class="row">
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <form id="adjusts" action="GTteachingfinecoursePerformanceSet-person!getPersonJoin" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                            ...
	                            <tbody>
									<c:forEach var="ebj" items="${finecoursepli }">
										<td>${ebj.tffineCourseConstructionProject.courseId }</td>
											<td>${ebj.tffineCourseConstructionProject.courseName }</td>
											<td title="${ebj.tffineCourseConstructionProject.tffineCourseConstructionLevel.courseLevelId }">
												${ebj.tffineCourseConstructionProject.tffineCourseConstructionLevel.courseLevel }
											</td>
											<td>${ebj.tffineCourseConstructionProject.projectSumScore }</td>
											<td title="${ebj.tffineCourseConstructionProject.tfterm.termId }">
												${ebj.tffineCourseConstructionProject.tfterm.term }
											</td>
											<td>${ebj.singelScore }</td>
											<td>${ebj.tffineCourseConstructionProject.chargePersonId }</td>
											<td>${teachermp[ebj.tffineCourseConstructionProject.chargePersonId] }</td>
											...
											<td>
												<c:if test="${teacher.teacherId!=ebj.tffineCourseConstructionProject.chargePersonId }">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfinecoursePerformanceSet-person!getPersonJoin?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfinecoursePerformanceSet-person!getPersonJoin?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfinecoursePerformanceSet-person!getPersonJoin?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfinecoursePerformanceSet-person!getPersonJoin?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
	...
	$('.quitpaper').click(function() {
		...
		swal({   title: "确定退出?",   
				 ...
				 function(isConfirm){   
					 if (isConfirm) {     
						 $.post("GTteachingfinecoursePerformanceSet-person!quitProject",
