...
<body class="gray-bg"  onload="DoCheck()">
	                ...
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <button class="btn  btn-primary openaddm" type="submit" data-backdrop="true" data-toggle="modal" data-target="#utdialog">
	                        	 <strong>新增企业工作站OR联合培养基地</strong>
	                         </button><br><br>
	                    <form id="adjusts" action="GTteachingfirmbaseconPerformanceSet-project!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfirmbaseconPerformanceSet-project!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfirmbaseconPerformanceSet-project!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfirmbaseconPerformanceSet-project!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTteachingfirmbaseconPerformanceSet-project!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
			...
			if(!isNaN($('#projcnumber').val().trim())){
				swal({   
		    		...
		    		closeOnCancel: true }, 
		    			function(isConfirm){   
		    				if (isConfirm) {
		    					$.post("GTteachingfirmbaseconPerformanceSet-project!addProject",
		    							...
		    							function(data,status){
		    								 if(status=="success"){
		    									 if(data=="succ"){
		    										 swal("添加成功","","success");
		    	    								 setTimeout(function() {
		    	    									 window.location.replace("GTteachingfirmbaseconPerformanceSet-project!gainAllProject?pagenum=1");
		    										}, 2000);
		    									 }else{
		    										 swal("成功","","warning");
		    									 }
    		...
    		if(!isNaN($('#projcnumber').val().trim())){
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("GTteachingfirmbaseconPerformanceSet-project!updateProject",
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("GTteachingfirmbaseconPerformanceSet-project!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		$.post("GTteachingfirmbaseconPerformanceSet-project!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("GTteachingfirmbaseconPerformanceSet-project!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "firmtrainproject.projectId":projectId},
		function(data,status){
    ...
    $('.joinProj').click(function(e) {
		...
		swal({
    		...
    		function(isConfirm){
    			if(isConfirm){
    				$.post("GTteachingfirmbaseconPerformanceSet-project!joinPeoject",
