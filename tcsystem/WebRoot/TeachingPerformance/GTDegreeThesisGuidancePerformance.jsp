									...
									<tbody>
										<c:forEach var="degreeThesisGuidancePerf"
											...
											<tr>
												...
												<!-- 操作 -->
												<td>
													<a  class="btn btn-primary btn-sm update" data-toggle="modal" data-target="#update">修改</a>
...
<!-- 													<button class="btn btn-primary btn-sm deleteInfo" >删除</button> -->
    ...
    $('#addDTGPerformance').click(function() {
		if($('#teacherName').val().trim()!=""&& $('#teacherId').val().trim()!="" && $('#degreeThesisName').val().trim()!=""){
...
// 		alert($(this).parent().parent()[0].cells[4].innerHTML);
