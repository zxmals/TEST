...
<body class="gray-bg"  onload="DoCheck()">
	<div class="datepick">
		<span>选择日期范围</span>
		<div>
			<form action="GTscientificresearchpro-projectset!gainAllscienpro?pagenum=1" method="post" name="pickdate" id="pickdates">
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTscientificresearchpro-projectset!gainAllscienpro?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTscientificresearchpro-projectset!gainAllscienpro?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTscientificresearchpro-projectset!gainAllscienpro?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="GTscientificresearchpro-projectset!gainAllscienpro?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
	            ...
	            <div class="modal-content">
	                <div class="modal-body">
	                    <div class="row">
	                    			<div class="form-group" style="display: none">                                
	                                    <label>项目ID:</label>
	                                    <input id="joinsrpId" type="text"  class="form-control nullcheck">
	                                </div>
	                    			<div class="form-group">                            
	                                    <label>参与身份:</label>
	                                ...
	                                <div class="form-group">                                
	                                    <label>项目当年到款:</label>
	                                    <input id="yearsfunds" type="text"  class="form-control nullcheck">
	                                    <span style="color:rgb(255,0,255)">单位：(万元)</span>
	                                </div>
	                                <hr> 
	                            	<div>
    ...
    $('#changelength').change(function() {
		...
		window.location.replace("GTscientificresearchpro-projectset!gainAllscienpro?pagenum=1&limit="+$(this).val().trim()+"&foredate="+$('#date1').val().trim()+"&afterdate="+$('#date2').val().trim());
	});
    ...
    $('#subadds').click(function() {
		if(checkadds()){
				$.post("GTscientificresearchpro-projectset!addSRProject",
						...
						function(data,status){
							 if(status=="success"){
								 if(data=="succ"){
									 swal("添加成功","","success");
    								 setTimeout(function() {
    									 window.location.replace("GTscientificresearchpro-projectset!gainAllscienpro?pagenum=1");
									}, 2000);
								 }else{
									 swal("新增失败: "+data);
								 }
    	...
    	if(checkadds()&&$('#srcsprojectId').val().trim()!=""){
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("GTscientificresearchpro-projectset!updateSRProject?pagenum=1",
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("GTscientificresearchpro-projectset!deleteSRProject?pagenum=1",
    							{"scienrhprojec.srprojectId":$('#sprojectId').val().trim()},
    							function(data,status){
    								if(status=="success"){
    									if(data=="succ"){
    ...
    $('.getMember').click(function() {
		var row = $(this).parent().parent();
		$.post("GTscientificresearchpro-projectset!getMember",
    ...
    $('.joinProj').click(function(e) {
	    ...
	    if(btn.attr("isConfirm")!="1"){
	    	...
	    	$('#joinsrpId').prop("value",btn.parent().parent()[0].cells[0].innerHTML.trim());
    ...
    $('#subjoin').click(function() {
    	if($('#joinsrpId').val().trim()!=""&&$('#joinIdentity').val().trim()!=""&&$('#yearsfunds').val().trim()!=""){
    		$.post("GTscientificresearchpro-projectset!joinSrproject",
    				{"scienrhprojec.srprojectId":$('#joinsrpId').val().trim(),
    				 "teacherandsrp.yearFunds":$('#yearsfunds').val().trim(),
