	...
	<form name="Audit" action="" method="post">
		<table
			...
			<tr>
				...
				<c:if test="${sessionScope.checkOutStatus_UTG=='3' }">
					<td><font color="blue">管理员审核通过</font></td>
				</c:if>
				<c:if test="${sessionScope.checkOutStatus_UTG=='4' }">
			...
			<c:forEach var="TfUndergraduateTutorGuidancePerformance"
				...
				<tr>
					...
					<c:if test="${sessionScope.checkOutStatus_UTG=='4' }">
						<c:if test="${TfUndergraduateTutorGuidancePerformance.checkOut== '1' }">
							<td><font color="orange" size="2">待审核</font></td>
						</c:if>
						<c:if test="${TfUndergraduateTutorGuidancePerformance.checkOut== '3' }">
							<td><font color="green" size="2">审核通过</font></td>
							</c:if>
						<c:if test="${TfUndergraduateTutorGuidancePerformance.checkOut== '2' }">
