...
<body style="padding-top:0px;margin-top:0px;">
	...
	<form
		action="GTUnjoinedActAudit!getUnjoinedActList"
		...
		<div class="datepick" style="font-size:12px;">
			...
			<div>
				...
				从:<input type="text" id="date1" class="Wdate"
					...
					name="foredate_UJA" id="foredate" />到:<input type="text"
		...
		<span style="margin-left:10px;">研究所：&nbsp;&nbsp;&nbsp;&nbsp;</span> <span>
			<select name="researchLab_UJA.researchLabId"
			...
			name="pageSize_UJA" id="pageSizeSelection">
				<c:forEach items="${pageSizeList }" var="pageSize">
					<option value="${pageSize }">&nbsp;&nbsp;&nbsp;${pageSize }&nbsp;&nbsp;&nbsp;</option>
				</c:forEach>
		</select> 条记录
		</span> <span>&nbsp;&nbsp;&nbsp;&nbsp; 审核状态： <select
			name="checkOutStatus_UJA" id="checkoutStatus">
	...
	<form name="Audit" action="" method="post">
		<table
			...
			<tr>
				<td>活动编号</td>		<td>活动名称</td>
				<td>参与人员</td>		<td>未参与原因</td>
				<td>是否请假</td>		<td>教师编号</td>
				<td>教师姓名</td>		<td>最终得分</td>
...
<!-- 					</c:if> -->
	...
	<div id="dividePageDev" style="height: 30px;">
		<span style="font-size:12px;color:#727272;"> 当前是第<font
			style=" color:blue; font-weight: bold;">${pageIndex }/${sessionScope.pageCount_UJA }</font>页
