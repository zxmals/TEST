  ...
  <body>
	...
	<form name="Audit"  action=""  method="post">
		<table class="table table-striped"  style="border-collapse:collapse">
			...
			<%
			if(o!=100000)
				if(SREDTdao.get(o).getTST()!=null)
					for(int i=0;i<SREDTdao.get(o).getTST().size();i++){ %>	
			<tr>
				<td><%=SREDTdao.get(o).getTST().get(i).getTalentProjectID() %></td>
				<td><%=SREDTdao.get(o).getTST().get(i).getTalentProjectName() %></td>
				<td><%=SREDTdao.get(o).getTST().get(i).getTeacherID() %></td>
				<td><%=SREDTdao.get(o).getTST().get(i).getTeacherName() %></td>
				<td><%=SREDTdao.get(o).getTST().get(i).getSelectedYear()%></td>
				<td><%=SREDTdao.get(o).getTST().get(i).getBaseScore()%></td>
				<td>
				<input type = "checkbox"  name =""  
				id="<%=SREDTdao.get(o).getTST().get(i).getTeacherID()+SREDTdao.get(o).getTST().get(i).getTalentProjectID() %>" 
				value="<%=SREDTdao.get(o).getTST().get(i).getTeacherID() %>,<%=SREDTdao.get(o).getTST().get(i).getTalentProjectID() %>"
				onchange="nullChange('<%=SREDTdao.get(o).getTST().get(i).getTeacherID()+SREDTdao.get(o).getTST().get(i).getTalentProjectID() %>')"/></td>
			</tr>
			<%}%>
		</table>
	</form>
  <input type="submit" value="提交" onclick="changeCheckboxValueAndSubmit('SelectedTalentProject',<%=o %>);"></input>
