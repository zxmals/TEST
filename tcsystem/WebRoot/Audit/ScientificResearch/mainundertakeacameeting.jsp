  ...
  <body>
	...
	<form name="Audit"  action=""  method="post">
		<table class="table table-striped"  style="border-collapse:collapse">
			...
			<%
			if(o!=100000)
				if(SREDTdao.get(o).getTMA()!=null)
					for(int i=0;i<SREDTdao.get(o).getTMA().size();i++){ %>	
			<tr>
				<td><%=SREDTdao.get(o).getTMA().get(i).getAcaMeetingID() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getAcaMeetingName() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getChargePerson() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getAcaMeetType() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getAcaMeetPlace() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getTeacherID() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getTeacherName() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getSelfUnderTakeTask() %></td>
				<td><%=SREDTdao.get(o).getTMA().get(i).getBaseScore()%></td>
				<td>
				<input type = "checkbox"  name =""  
				id="<%=SREDTdao.get(o).getTMA().get(i).getTeacherID()+SREDTdao.get(o).getTMA().get(i).getAcaMeetingID() %>" 
				value="<%=SREDTdao.get(o).getTMA().get(i).getTeacherID() %>,<%=SREDTdao.get(o).getTMA().get(i).getAcaMeetingID() %>"
				onchange="nullChange('<%=SREDTdao.get(o).getTMA().get(i).getTeacherID()+SREDTdao.get(o).getTMA().get(i).getAcaMeetingID() %>')"/></td>
			</tr>
			<%}%>
		</table>
	</form>
  <input type="submit" value="提交" onclick="changeCheckboxValueAndSubmit('MainUndertakeAcademicMeeting',<%=o %>);"></input>
