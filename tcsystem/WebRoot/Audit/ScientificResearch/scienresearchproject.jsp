  ...
  <body>
	...
	<form name="Audit"  action=""  method="post">
		<table class="table table-striped"  style="border-collapse:collapse">
			<tr>
				<td>科研项目编号</td>				<td>科研项目名称</td>
				<td>项目原编号</td>				<td>项目类型</td>
				<td>负责人</td>				<td>项目来源</td>
				<td>立项年份</td>				<td>项目总金/万</td>
				<td>教师编号</td>  				<td>教师姓名</td>
				<td>本人承担任务</td>							<td>当年到款/万</td>				
				<td>最终分数</td>
				<td>全通过&nbsp;<input type = "checkbox"  name =""  id="allCheck" onchange="allAlowOrNot()" /></td>
			</tr>
			<%
			if(o!=100000)
				if(SREDTdao.get(o).getTS()!=null)
					for(int i=0;i<SREDTdao.get(o).getTS().size();i++){ %>	
			<tr>
				<td><%=SREDTdao.get(o).getTS().get(i).getSRProjectID() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getSRPName() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getProjectNumber() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getProjectType() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getChargePerson() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getProjectSource() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getAdmitedProjectYear() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getSumFunds() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getTeacherID()%></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getTeacherName() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getSelfUndertakeTask() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getYearFunds() %></td>
				<td><%=SREDTdao.get(o).getTS().get(i).getBaseScore() %></td>
				<td>
				<input type = "checkbox"  name =""  
				id="<%=SREDTdao.get(o).getTS().get(i).getTeacherID()+SREDTdao.get(o).getTS().get(i).getSRProjectID()%>" 
				value="<%=SREDTdao.get(o).getTS().get(i).getTeacherID() %>,<%=SREDTdao.get(o).getTS().get(i).getSRProjectID() %>"
				onchange="nullChange('<%=SREDTdao.get(o).getTS().get(i).getTeacherID()+SREDTdao.get(o).getTS().get(i).getSRProjectID()%>')"/></td>
			</tr>
			<%}%>
		</table>
	</form>
  <input type="submit" value="提交" onclick="changeCheckboxValueAndSubmit('ScientificResearchProject',<%=o %>);"></input>
