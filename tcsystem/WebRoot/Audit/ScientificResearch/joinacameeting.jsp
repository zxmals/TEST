  ...
  <body>
	...
	<form name="Audit"  action=""  method="post">
		<table class="table table-striped"  style="border-collapse:collapse">
			...
			<%
			if(o!=100000)
				if(SREDTdao.get(o).getTM()!=null)
					for(int i=0;i<SREDTdao.get(o).getTM().size();i++){ %>	
			<tr>
				<td><%=SREDTdao.get(o).getTM().get(i).getAcaMeetName() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getJoinAcaMID() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getMeetingType() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getMeetingPlace() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getMeetingPaperID() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getPaperTitle() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getAuthor() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getAuthorIdentity() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getPRCodition() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getTeacherID() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getTeachername() %></td>
				<td><%=SREDTdao.get(o).getTM().get(i).getBaseScore() %></td>
				<td>
				<input type = "checkbox"  name =""  
				id="<%=SREDTdao.get(o).getTM().get(i).getTeacherID()+SREDTdao.get(o).getTM().get(i).getJoinAcaMID()  %>" 
				value="<%=SREDTdao.get(o).getTM().get(i).getTeacherID() %>,<%=SREDTdao.get(o).getTM().get(i).getJoinAcaMID() %>"
				onchange="nullChange('<%=SREDTdao.get(o).getTM().get(i).getTeacherID()+SREDTdao.get(o).getTM().get(i).getJoinAcaMID()  %>')"/></td>
			</tr>
			<%}%>
		</table>
	</form>
  <input type="submit" value="提交" onclick="changeCheckboxValueAndSubmit('JoinAcademicMeeting',<%=o %>);"></input>
