...
<jsp:directive.page import="com.nuaa.ec.science.dao.AcademicWorkDAO"/>
<jsp:directive.page import="com.nuaa.ec.science.dao.TeacherANDAcademicWorkDAO"/>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">科研绩效添加</h1>
          <a href="<%=basePath %>PersonManager/addPerformance_qklw">期刊论文</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_kyxm">科研项目</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_xszz">学术著作</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_xmjl">项目奖励</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_cjxshy">参加学术会议</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_yqzjjx">邀请专家讲学</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_zcbxshy">主承办学术会议</a><br /><br />
         <a href="<%=basePath %>PersonManager/addPerformance_rxrcgc">入选人材工程</a><br /><br />
	<s:debug></s:debug>
