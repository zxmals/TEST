     ...
     <table class="table table-striped"  style="border-collapse:collapse">
		...
		<%if(f!=null)for(int i=0;i<f.size();i++){ %>
			...
			<td><%=f.get(i).getFinalScore()%></td>
				<td><input type="submit" value="删除" onclick="javascript:document.f.action='AddTeachingResearch!delTeachingResearch?ProjectID=<%=f.get(i).getProjectID()%>';document.f.submit();"></input></td>
			</tr>
		<%} %>
	</table>
	</center>
