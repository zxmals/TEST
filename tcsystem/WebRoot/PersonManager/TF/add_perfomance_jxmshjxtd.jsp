      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="table table-striped"  style="border-collapse:collapse">
			...
			<tr><td>ID</td><td><input type="text" name="TeacherTeamPerformanceID"/></td></tr>
			<tr><td>称号级别</td>
			<td><select name="TeachRewardLevelName"  >
			     <%if (b!=null ){
			...
			<tr><td>操作</td><td><input type="submit" value="提交" onclick="javascript:document.f.action='AddFamousTeacherTeam!addFamousTeacherTeam';document.f.submit();"></input></td></tr>
	</table>
	</form>
	</center>
	<s:debug></s:debug>
