...
<jsp:directive.page import="com.nuaa.ec.teaching.dao.Teaching_rearch_PerformanceDAO"/>
<jsp:directive.page import="com.nuaa.ec.science.Permodel.TeacherLoginStatus"/>
<jsp:directive.page import="com.nuaa.ec.teaching.model.TFTeaching_rearch_Performance"/>
...
<%
    ...
    Teaching_rearch_PerformanceDAO ctpdao = new Teaching_rearch_PerformanceDAO();
     List<TFTeaching_rearch_Performance> f = ctpdao.getAllInfoTeachingResearch(a.getTeacherID());
  %>
  <%//判断操作是否成功
     int g = 888;
...
<body class="gray-bg" onload="DoCheck()">
                       ...
                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
			                        ...
			                        <td><%=f.get(i).getProjectID()%></td>
			                        <td><%=f.get(i).getProject()%></td>
			                        <td><%=f.get(i).getFundLevel()%></td>
			                        <td><%=f.get(i).getEvaluationReaults()%></td>
			                        ...
			                        <td><a    class="btn btn-primary btn-sm" data-toggle="modal"   onclick="doupdate('<%=i %>')" data-target="#update" >修改</a>
			                             <a  onclick="dodel('<%=f.get(i).getProjectID() %>')"  class="btn btn-primary btn-sm del" >删除</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddTeachingResearch!addTeachingResearch;location.reload()">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input type="text" class="form-control" name="ProjectID"><span class="help-block m-b-none">请输入ID</span>
                                </div>
                                <div class="form-group">
                                    <label>项目名称：</label>
                                    <input type="text" class="form-control" name="Project"><span class="help-block m-b-none"></span>
                                </div>
                                <div class="form-group">
                                <label>项目拨款：</label>
                                    <select class="form-control m-b" name="FundLevel">
                                ...
                                <div class="form-group">
                                <label>评估解果：</label>
                                    <select class="form-control m-b" name="Reaults">
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog" 
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddTeachingResearch!updateTeachingResearch">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id = "cell2" type="text" class="form-control" name="ProjectID" readonly="true" value="" ><span class="help-block m-b-none" value="$(tid).data(id)" readonly="true">请输入ID</span>
                                </div>
                                <div class="form-group">
                                    <label>项目名称：</label>
                                    <input id="cell3" type="text" class="form-control" name="Project" value=""><span class="help-block m-b-none"></span>
                                </div>
                                <div class="form-group">
                                <label>项目拨款：</label>
                                    <select id= "cell4" class="form-control m-b" name="FundLevel">
                                ...
                                <div class="form-group">
                                <label>评估结果：</label>
                                    <select id= "cell5" class="form-control m-b" name="Reaults">
    ...
    swal({ 
        ...
        document.f.action="AddTeachingResearch!delTeachingResearch?ProjectID="+delid;
        f.submit();
    }); 
