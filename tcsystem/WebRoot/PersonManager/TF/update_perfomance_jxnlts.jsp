...
<%
    ...
    List<String> b = gadao.getAllColname("TFTeachingAbilityImprove__Level", "Improve__level");
...
<body class="gray-bg"  onload="DoCheck()">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
			                        ...
			                        <td><a    class="btn btn-primary btn-sm" data-toggle="modal"    onclick="doupdate('<%=i %>')" data-target="#update" >修改</a>
			                             <a  onclick="dodel('<%=f.get(i).getEventID() %>')"  class="btn btn-primary btn-sm del" >删除</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddTeachingAbilityImprove!addTeachingAbilityImprove">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input type="text" class="form-control" name="EventID"><span class="help-block m-b-none">请输入ID</span>
                                </div>
                                

                                 <div class="form-group">
                                    <label>活动名称：</label>
                                    <input type="text" class="form-control" name="EventName"><span class="help-block m-b-none"></span>
                                </div>
                                    
                                <div class="form-group">
                                <label>活动类别：</label>
                                    <select class="form-control m-b" name="Improve__level">
                                ...
                                <div class="form-group">
                                    <label>活动时长：</label>
                                    <input type="text" class="form-control" name="sumhours"><span class="help-block m-b-none"></span>
                                </div>
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog" 
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" id="onlyForm" action="AddTeachingAbilityImprove!updateTeachingAbilityImprove">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id = "cell2" type="text" class="form-control" name="EventID" readonly="true" value="" ><span class="help-block m-b-none" value="$(tid).data(id)" readonly="true">请输入ID</span>
                                </div>
                                 <div class="form-group">
                                    <label>活动名称：</label>
                                    <input id="cell3" type="text" class="form-control" name="EventName" value=""><span class="help-block m-b-none"></span>
                                </div>    
                                <div class="form-group">
                                <label>活动类别：</label>
                                    <select id= "cell4" class="form-control m-b" name="Improve__level">
                                ...
                                <div class="form-group">
                                    <label>活动时长：</label>
                                    <input type="text" id="cell5" class="form-control" name="sumhours"><span class="help-block m-b-none"></span>
                                </div>
                                <div>
                                    <button type="button"   class="btn btn-outline btn-primary pull-right m-t-n-xs" data-dismiss="modal">关闭</button>
                                    <button  class="btn  btn-primary pull-left m-t-n-xs " type="submit">
    ...
    swal({ 
        ...
        document.f.action="AddTeachingAbilityImprove!delTeachingAbilityImprove?EventID="+delid;
        f.submit();
    }); 
