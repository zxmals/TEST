     ...
     <table class="table table-striped"  style="border-collapse:collapse">
		...
		<%if(f!=null)for(int i=0;i<f.size();i++){ %>
			...
			<td><%=f.get(i).getFinalScore()%></td>
				<td><input type="submit" value="删除" onclick="javascript:document.f.action='AddDegreeThesisGuidance!delDegreeThesisGuidance?Degree_thesisID=<%=f.get(i).getDegree_thesisID()%>';document.f.submit();"></input></td>
			</tr>
		<%} %>
	</table>
	</center>
