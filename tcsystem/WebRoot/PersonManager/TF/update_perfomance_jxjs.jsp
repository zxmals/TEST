...
<jsp:directive.page import="com.nuaa.ec.teaching.dao.TeachingCompetition_PerformanceDAO"/>
<jsp:directive.page import="com.nuaa.ec.science.Permodel.TeacherLoginStatus"/>
<jsp:directive.page import="com.nuaa.ec.teaching.model.TFTeachingCompetition_Performance"/>
...
<%
     ...
     List<String> b = gadao.getAllColname("TFTeachingCompetition_RewardLevel", "competRewardLevel");


    TeachingCompetition_PerformanceDAO tcpdao = new TeachingCompetition_PerformanceDAO();
     List<TFTeachingCompetition_Performance> f = tcpdao.getAllInfoTeachingCompetition(a.getTeacherID());
...
<body class="gray-bg"  onload="DoCheck()">
                       ...
                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
			                        ...
			                        <td><%=f.get(i).getCompetitionID()%></td>
			                        <td><%=f.get(i).getCompetitionName()%></td>
			                        <td><%=f.get(i).getCompetRewardLevel()%></td>
			                        ...
			                        <td><a    class="btn btn-primary btn-sm" data-toggle="modal"    onclick="doupdate('<%=i %>')" data-target="#update" >修改</a>
			                             <a  onclick="dodel('<%=f.get(i).getCompetitionID() %>')"  class="btn btn-primary btn-sm del" >删除</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddTeachingCompetition!addTeachingCompetition">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input type="text" class="form-control" name="competitionID"><span
                                  ...
                                  <div class="form-group">
                                    <label>竞赛名称：</label>
                                    <input type="text" class="form-control" name="competitionName"><span class="help-block m-b-none"></span>
                                </div>
                                    
                                <div class="form-group">
                                <label>奖励级别：</label>
                                    <select class="form-control m-b" name="competRewardLevel">
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog" 
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" id="onlyForm" action="AddTeachingCompetition!updateTeachingCompetition">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id="cell2" type="text" class="form-control" name="competitionID"
                                           readonly="true" value=""><span class="help-block m-b-none"
                                                                          value="$(tid).data(id)"
                                                                          readonly="true">请输入ID</span>
                                </div>
                                <div class="form-group">
                                    <label>竞赛名称：</label>
                                    <input id="cell3" type="text" class="form-control" name="competitionName" value=""><span class="help-block m-b-none"></span>
                                </div>    
                                <div class="form-group">
                                <label>奖励级别：</label>
                                    <select id= "cell4" class="form-control m-b" name="competRewardLevel">
    ...
    swal({ 
        ...
        document.f.action="AddTeachingCompetition!delTeachingCompetition?CompetitionID="+delid;
        f.submit();
    }); 
