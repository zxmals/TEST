      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="table table-striped"  style="border-collapse:collapse">
			...
			<tr><td>ID</td><td><input type="text" name="competitionID"/></td></tr>
			<tr><td>竞赛名称</td><td><input type="text" name="competitionName" /></td></tr>
			<tr><td>奖励级别</td>
			<td><select name="competRewardLevel"  >
			     <%if (b!=null ){
			...
			<tr><td>操作</td><td><input type="submit" value="提交" onclick="javascript:document.f.action='AddTeachingCompetition!addTeachingCompetition';document.f.submit();"></input></td></tr>
	</table>
	</form>
	</center>
	<s:debug></s:debug>
