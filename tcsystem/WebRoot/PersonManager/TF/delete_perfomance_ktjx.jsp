     ...
     <table class="table table-striped"  style="border-collapse:collapse">
		...
		<%if(f!=null)for(int i=0;i<f.size();i++){ %>
			...
			<td><%=f.get(i).getFinalScore()%></td>
				<td><input type="submit" value="删除" onclick="javascript:document.f.action='AddClassTeach!delClassTeach?ClassPefromanceID=<%=f.get(i).getClassPefromanceID()%>';document.f.submit();"></input></td>
			</tr>
		<%} %>
	</table>
	</center>
