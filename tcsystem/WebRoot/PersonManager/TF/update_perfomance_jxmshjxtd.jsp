...
<jsp:directive.page import="com.nuaa.ec.teaching.dao.FamousTeacherTeam_PerformanceDao"/>
<jsp:directive.page import="com.nuaa.ec.science.Permodel.TeacherLoginStatus"/>
<jsp:directive.page import="com.nuaa.ec.teaching.model.TFFamousTeacherTeam_Performance"/>
...
<%
     ...
     List<String> b = gadao.getAllColname("TFFamousTeacherTeam_RewadLevel", "TeachRewardLevelName");
     List<String> c = gadao.getAllColname("SelfUndertakeTask", "UndertakeTaskName");
     FamousTeacherTeam_PerformanceDao ctpdao = new FamousTeacherTeam_PerformanceDao();
     List<TFFamousTeacherTeam_Performance> f = ctpdao.getAllInfoFamousTeacherTeam(a.getTeacherID());
...
<body class="gray-bg"  onload="DoCheck()">
                       ...
                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
			                        ...
			                        <td><%=f.get(i).getTeacherTeamPerformanceID()%></td>
			                        <td><%=f.get(i).getTeachRewardLevel()%></td>
			                        <td><%=f.get(i).getSelfUndertakeTask()%></td>
			                        <td><%=f.get(i).getSingelScore()%></td>
			                        ...
			                        <td><a    class="btn btn-primary btn-sm" data-toggle="modal"    onclick="doupdate('<%=i %>')" data-target="#update" >修改</a>
			                             <a  onclick="dodel('<%=f.get(i).getTeacherTeamPerformanceID() %>')"  class="btn btn-primary btn-sm del" >删除</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddFamousTeacherTeam!addFamousTeacherTeam">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input type="text" class="form-control" name="TeacherTeamPerformanceID"><span class="help-block m-b-none">请输入ID</span>
                                </div>

                                <div class="form-group">
                                <label>称号级别：</label>
                                    <select class="form-control m-b" name="TeachRewardLevelName">
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog" 
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" id="onlyForm" action="AddFamousTeacherTeam!updateFamousTeacherTeam">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id = "cell2" type="text" class="form-control" name="CompetitionID" readonly="true" value="" ><span class="help-block m-b-none" value="$(tid).data(id)" readonly="true">请输入ID</span>
                                </div>
                                
                                <div class="form-group">
                                <label>称号级别：</label>
                                    <select id= "cell3" class="form-control m-b" name="TeachRewardLevelName">
                                ...
                                <div>
                                <label>个人承担任务：</label>
                                    <select id= "cell4" class="form-control m-b" name="UndertakeTaskName">
    ...
    swal({ 
        ...
        document.f.action="AddFamousTeacherTeam!delFamousTeacherTeam?TeacherTeamPerformanceID="+delid;
        f.submit();
    }); 
