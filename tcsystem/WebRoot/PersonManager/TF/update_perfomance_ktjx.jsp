...
<jsp:directive.page import="com.nuaa.ec.teaching.dao.ClassTeach_PefromanceDAO"/>
...
<jsp:directive.page import="com.nuaa.ec.teaching.model.TFClassTeach_Performance"/>
...
<%
     ...
     List<String> b = gadao.getAllColname("TFClassTeach_Time", "sumtimeScope");
     List<String> c = gadao.getAllColname("TFClassTeach_Evaluation", "evaluResult");
     ClassTeach_PefromanceDAO ctpdao = new ClassTeach_PefromanceDAO();
     List<TFClassTeach_Performance> f = ctpdao.getAllInfoClassTeach(a.getTeacherID());
...
<body class="gray-bg"  onload="DoCheck()">
                       ...
                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
			                        ...
			                        <td><%=f.get(i).getClassPefromanceID()%></td>
			                        <td><%=f.get(i).getSumtimeScope()%></td>
			                        <td><%=f.get(i).getEvaluResult()%></td>
			                        <td><%=f.get(i).getSumtime()%></td>
			                        ...
			                        <td><a    class="btn btn-primary btn-sm" data-toggle="modal"    onclick="doupdate('<%=i %>')" data-target="#update" >修改</a>
			                             <a  onclick="dodel('<%=f.get(i).getClassPefromanceID() %>')"  class="btn btn-primary btn-sm del" >删除</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" action="AddClassTeach!addClassTeach">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input type="text" class="form-control" name="ClassPefromanceID"><span class="help-block m-b-none">请输入ID</span>
                                </div>
                              
                                <div class="form-group">
                                <label>教学时长：</label>
                                    <select class="form-control m-b" name="sumtimeScope">
                                ...
                                <div class="form-group">
                                <label>教学评估：</label>
                                    <select class="form-control m-b" name="evaluResult">
                                  ...
                                  <div class="form-group">
                                    <label>教学总时长：</label>
                                    <input type="text" class="form-control" name="sumtime"><span class="help-block m-b-none"></span>
                                </div>
                                    
                            
                                <div>
                                    <button type="button" class="btn btn-outline btn-primary pull-right m-t-n-xs" data-dismiss="modal">关闭</button>
                                    <button onclick="javascript:window.location.reload()" class="btn  btn-primary pull-left m-t-n-xs " type="submit">
   ...
   <div id="update" class="modal fade" aria-hidden="true"tabindex="-1" role="dialog"     aria-labelledby="myModalLabel">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                            ...
                            <form role="form" id="onlyForm" action="AddClassTeach!updateClassTeach">
                                ...
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id = "cell2" type="text" class="form-control" name="ClassPefromanceID" readonly="true" value="" ><span class="help-block m-b-none" value="$(tid).data(id)" readonly="true">请输入ID</span>
                                </div>
                                
                                <div class="form-group">
                                <label>教学时长：</label>
                                    <select id= "cell3" class="form-control m-b" name="sumtimeScope">
                                ...
                                <div class="form-group">
                                <label>教学评估：</label>
                                    <select id= "cell4" class="form-control m-b" name="evaluResult">
                                ...
                                <div class="form-group">
                                    <label>教学总时长：</label>
                                    <input id="cell5" type="text" class="form-control" name="sumtime" value=""><span class="help-block m-b-none"></span>
                                </div>    
    ...
    swal({ 
        ...
        document.f.action="AddClassTeach!delClassTeach?ClassPefromanceID="+delid;
        f.submit();
    }); 
