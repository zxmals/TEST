      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="table table-striped"  style="border-collapse:collapse">
			...
			<tr><td>ID</td><td><input type="text" name="ClassPefromanceID"/></td></tr>
			<tr><td>教学时长</td>
			<td><select name="sumtimeScope"  >
			     <%if (b!=null ){
			...
			<tr><td>教学总时长</td><td><input type="text" name="sumtime" /></td></tr>
			<tr><td>操作</td><td><input type="submit" value="提交" onclick="javascript:document.f.action='AddClassTeach!addClassTeach';document.f.submit();"></input></td></tr>
	</table>
	</form>
	</center>
	<s:debug></s:debug>
