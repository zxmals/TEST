    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">学位论文指导</h1>
          ...
          <table class="table table-striped"  style="border-collapse:collapse">
			...
			<tr><td>ID</td><td><input type="text" name="Degree_thesisID"/></td></tr>
			<tr><td>学位论文名称</td><td><input type="text" name="Degree_thesisnName" /></td></tr>
			<tr><td>奖励级别</td>
			...
			<tr><td>操作</td><td><input type="submit" value="提交" onclick="javascript:document.f.action='AddDegreeThesisGuidance!addDegreeThesisGuidance';document.f.submit();"></input></td></tr>
	</table>
	</form>
	</center>
	<s:debug></s:debug>
