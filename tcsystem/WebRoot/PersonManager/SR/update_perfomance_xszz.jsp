...
<%
     ...
     List<WordsNumber> c = wndao.getWordNumberinfo();
    ...
    List<AcademicWork> h = new ArrayList<AcademicWork>();
	 f = dao.getAllXSZZ(a.getTeacherID());
...
<html lang="zh-CN">
  ...
  <title>NUAA-CEM绩效管理系统 - 个人绩效操作</title>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><a class="btn btn-primary btn-sm" data-toggle="modal"
                                        ...
                                        <a onclick="dodelJ('<%=f.get(i).getAcaworkID()%>','<%=a.getTeacherID()%>')"
                                ...
                                <label>字数：</label>
                                    <select class="form-control m-b" name="WordN">
                                        <%if (c!=null ){ for(int i=0;i<c.size();i++){ %>
					                         <option value="<%=c.get(i).getWordID() %>,<%=c.get(i).getWordNumber() %>"><%=c.get(i).getWordNumber() %></option>
				                        <%} }%>			
                                    </select>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <form role="form" id="upJ" action="addAWork!updateTandAcademicWork">
                                    <div class="form-group">
                                        <label>工号：</label>
