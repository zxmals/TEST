...
<%@ page import="com.nuaa.ec.science.model.ScientificResearchProject" %>
...
<%
    ...
    TeacherLoginStatus e = new TeacherLoginStatus();
    e = (TeacherLoginStatus) session.getAttribute("teacherloginStatus");
    List<ViewKYXM> f = new ArrayList<ViewKYXM>();
    List<ScientificResearchProject> h = new ArrayList<ScientificResearchProject>();
    f = dao.getAllViewKYXM(e.getTeacherID());
    h = dao.getAllViewKYXMproject();
        ...
        if (checkid != 999 && checkid != 888) {
            switch (checkid) {
                ...
                case 5:
                    ...
                    break;
                case 2:
                    swal("操作成功", "已成功修改项目!", "success");
                    break;
                case 6:
                    swal("操作成功", "已成功修改绩效!", "success");
                    break;
                case 3:
                            ...
                            <table id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><a class="btn btn-primary btn-sm" data-toggle="modal"
                                        ...
                                        <a onclick="dodelJ('+<%=f.get(i).getSRProjectID()%>+','+<%=a.getTeacherID()%>+')"
                    ...
                    <div class="example">
                        <form method="post" name="f1">
                            <table id="tb2" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    <td><%=h.get(i).getSRProjectID() %>
                                    </td>
                                    <td><%=h.get(i).getSRPName()%>
                                    </td>
                                    <td><%=h.get(i).getChargePerson()%>
                                    </td>
                                    <td><%=h.get(i).getProjectNumber()%>
                                    </td>
                                    <td><%=h.get(i).getProjectSource()%>
                                    </td>
                                    <td><%=h.get(i).getAdmitedProjectYear() %>
                                    </td>
                                    <td><%=h.get(i).getProjectType()%>
                                    </td>
                                    <td><%=h.get(i).getSumFunds() %>
                                    </td>
                                    ...
                                    <td><%if (h.get(i).getChargePersonID().equals(a.getTeacherID())) {%>
                                        ...
                                        <a onclick="dodelX('<%=h.get(i).getSRProjectID()%>')"
                                           class="btn btn-primary btn-sm del">删除</a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" action="AddSRProject!AddSRProject">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" action="AddSRProject!AddTandSRProject">
                            ...
                            <div class="form-group">
                                <label>ID：</label>
                                <input type="text" id="add2" readonly="true" class="form-control"
                                       name="SRProjectID"><span
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" id="onlyForm" action="AddSRProject!updateSRProject">
                            <div class="form-group">
                                <label>ID：</label>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <form role="form" id="Form" action="AddSRProject!updateTandSRProject">
                                <div class="form-group">
                                    <label>工号：</label>
                                ...
                                <div class="form-group">
                                    <label>姓名：</label>
                                    <input id="num1" type="text" readonly="true" class="form-control"
                                           name="TeacherName" readonly="true" value="<%=a.getTeacherName()%>">
                                </div>
                                <div class="form-group">
                                    <label>ID：</label>
                                    <input id="num2" type="text" class="form-control" name="SRProjectID"><span
                                        class="help-block m-b-none">请输入ID</span>
                                </div>
                                <div class="form-group">
                                    <label>当年到款</label>
                                    <input id="num3" type="text" class="form-control" name="YearFunds" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label>本人承担的任务：</label>
                                    <select id="num4" class="form-control m-b" name="UndertakeTaskName">
                                        <%
                                            if (d != null) {
                                                for (int i = 0; i < d.size(); i++) {
                                        %>
...
//            alert(tr1.rowIndex);
                ...
                document.getElementById("num3").value = document.getElementById("tb").rows[hang].cells[10].innerHTML;
                document.getElementById("num4").value = document.getElementById("tb").rows[hang].cells[11].innerHTML;
            }
        ...
        <script>
            function dodelX(delid) {
                swal({
                    ...
                    document.f.action = "AddSRProject!delSRProject?SRProjectID=" + delid;
                    f.submit();
                });
            ...
            function dodelJ(delid, teacherid) {
                swal({
                    ...
                    document.f.action = "AddSRProject!delTandSRProject?SRProjectID=" + delid + "&TeacherID=" + teacherid;
                    f.submit();
                });
