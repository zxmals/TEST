...
<%@ page import="com.nuaa.ec.science.model.InvitedExpertsSpeech" %>
<%
...
<%
    ...
    List<InvitedExpertsSpeech> h = new ArrayList<InvitedExpertsSpeech>();
    f = dao.getAllYQZJJXCp(a.getTeacherID());
    h = dao.getAllYQZJJXprojectCp();
%>
<%
    //判断操作是否成功
    int g = 888;
                        ...
                        <form method="post" name="f">
                            <table id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><%=f.get(i).getIESpeechID()%>
                                    </td>
                                    <td><%=f.get(i).getExpertsName()%>
                                    </td>
                                    <td><%=f.get(i).getCountryName() %>
                                    </td>
                                    <td><%=f.get(i).getExpertTypeName() %>
                                    </td>
                                    <td><%=f.get(i).getLectureName() %>
                                    </td>
                                    <td><%=f.get(i).getSpeechDate() %>
                                    </td>
                                    ...
                                    <td><a class="btn btn-primary btn-sm" data-toggle="modal"
                                        ...
                                        <a onclick="dodelJ('<%=f.get(i).getIESpeechID()%>','<%=a.getTeacherID()%>')"
                    ...
                    <div class="example">
                        <form method="post" name="f1">
                            <table id="tb2" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    <td><%=h.get(i).getIESpeechID()%>
                                    </td>
                                    <td><%=h.get(i).getExpertsName()%>
                                    </td>
                                    <td><%=h.get(i).getCountryName() %>
                                    </td>
                                    <td><%=h.get(i).getExpertTypeName() %>
                                    </td>
                                    <td><%=h.get(i).getLectureName() %>
                                    </td>
                                    <td><%=h.get(i).getSpeechDate() %>
                                    </td>
                                    ...
                                    <td><%if (h.get(i).getChargePersonID().equals(a.getTeacherID())) {%>
                                        ...
                                        <a onclick="dodelX('<%=h.get(i).getIESpeechID() %>')"
                                           class="btn btn-primary btn-sm del">删除</a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" action="AddIESpeech!AddIESpeech">
                            <div class="form-group">
                                <label>讲座名称</label>
                                <input type="text" class="form-control" name="LectureName" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>讲座日期</label>
                                <input type="text" class="form-control" name="LectureDate" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>专家姓名：</label>
                                <input type="text" class="form-control" name="ExpertsName"><span
                            ...
                            <div class="form-group">
                                <label>专家类别：</label>
                                <select class="form-control m-b" name="ExpertTypeName">
                                    <%
                                        if (b != null) {
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    ...
                    <form role="form" action="AddIESpeech!AddTandIESpeech">
                        <div class="form-group">
                            <label>工号：</label>
                        ...
                        <div class="form-group">
                            <label>ID：</label>
                            <input id="add2" type="text" class="form-control" name="IESpeechID"><span
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" id="onlyForm" action="AddIESpeech!updateIESpeech">
                            <div class="form-group">
                                <label>ID：</label>
                                <input id="cell0" type="text" class="form-control" name="IESpeechID"><span
                                    class="help-block m-b-none" readonly="true">请输入ID</span>
                            </div>
                            <div class="form-group">
                                <label>讲座名称</label>
                                <input id="cell4" type="text" class="form-control" name="LectureName" placeholder="">
                            </div>
                             <div class="form-group">
                                <label>讲座日期</label>
                                <input id="cell4" type="text" class="form-control" name="LectureDate" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>专家姓名：</label>
                                <input id="cell1" type="text" class="form-control" name="ExpertsName"><span
                                    class="help-block m-b-none"></span>
                            </div>

                            <div class="form-group">
                                <label>国籍：</label>
                                <select id="cell2" class="form-control m-b" name="CountryName">
                                    <%
                                        if (c != null) {
                                            for (int i = 0; i < c.size(); i++) {
                                    %>
                            ...
                            <div class="form-group">
                                <label>专家类别：</label>
                                <select id="cell3" class="form-control m-b" name="ExpertTypeName">
                                    <%
                                        if (b != null) {
                                            for (int i = 0; i < b.size(); i++) {
                                    %>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" id="onlyForm1" action="AddIESpeech!updateTandIESpeech">
                            ...
                            <div class="form-group">
                                <label>ID：</label>
                                <input id="num2" type="text" class="form-control" name="IESpeechID"><span
                                    class="help-block m-b-none" readonly="true">请输入ID</span>
                            </div>
                            <div class="form-group">
                                <label>本人承担的任务：</label>
...
//            alert(tr1.rowIndex);
                ...
                document.getElementById("num3").value = document.getElementById("tb").rows[hang].cells[7].innerHTML;
            }
            ...
            function dodelX(delid) {
                swal({
                    ...
                    document.f.action = "AddIESpeech!delIESpeech?IESpeechID=" + delid;
                    f.submit();
                });
            ...
            function dodelJ(delid, teacherid) {
                swal({
                    ...
                    document.f.action = "AddIESpeech!delTandIESpeech?IESpeechID=" + delid + "&TeacherID=" + teacherid;
                    f.submit();
                });
            }
        </script>
