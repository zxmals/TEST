...
<%@ page import="com.nuaa.ec.science.model.MainUndertakeAcademicMeeting" %>
...
<%
    ...
    List<MainUndertakeAcademicMeeting> h = new ArrayList<MainUndertakeAcademicMeeting>();
    f = dao.getAllZCBXSHY(a.getTeacherID());
    h = dao.getAllZCBXSHYproject();
                        ...
                        <form method="post" name="f">
                            <table id="tb" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><%=f.get(i).getAcaMeetingID()%>
                                    </td>
                                    <td><%=f.get(i).getAcaMeetingName()%>
                                    </td>
                                    <td><%=f.get(i).getChargePerson() %>
                                    </td>
                                    <td><%=f.get(i).getAcaMeetTypeName() %>
                                    </td>
                                    <td><%=f.get(i).getAcaMeetPlaceName() %>
                                    </td>
                                    ...
                                    <td><a class="btn btn-primary btn-sm" data-toggle="modal"
                                        ...
                                        <a onclick="dodelJ('<%=f.get(i).getAcaMeetingID()%>','<%=a.getTeacherID()%>')"
                    ...
                    <div class="example">
                        <form method="post" name="f1">
                            <table id="tb2" class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeA">
                                    <td><%=h.get(i).getAcaMeetingID()%>
                                    </td>
                                    <td><%=h.get(i).getAcaMeetingName()%>
                                    </td>
                                    <td><%=h.get(i).getChargePerson() %>
                                    </td>
                                    <td><%=h.get(i).getAcaMeetType() %>
                                    </td>
                                    <td><%=h.get(i).getAcaMeetPlace() %>
                                    </td>
                                    ...
                                    <td><%if (h.get(i).getChargePersonID().equals(a.getTeacherID())) {%>
                                        ...
                                        <a onclick="dodelX('<%=h.get(i).getAcaMeetingID() %>')"
                                           class="btn btn-primary btn-sm del">删除</a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" action="AddMUAMeeting!AddMUAMeeting">
                            <div class="form-group">
                                <label>会议名称</label>
                                <input type="text" class="form-control" name="AcaMeetingName" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>负责人</label>
                            ...
                            <div class="form-group">
                                <label>会议类别：</label>
                                <select class="form-control m-b" name="AcaMeetType">
                                    <%
                                        if (d != null) {
                            ...
                            <div class="form-group">
                                <label>会议地点：</label>
                                <select class="form-control m-b" name="AcaMeetPlace">
                                    <%
                                        if (b != null) {
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    ...
                    <form role="form" action="AddMUAMeeting!AddTandMUAMeeting">
                        <div class="form-group">
                            <label>工号：</label>
                        ...
                        <div class="form-group">
                            <label>ID：</label>
                            <input id="add2" type="text" class="form-control" name="AcaMeetingID"><span
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" id="onlyForm1" action="AddMUAMeeting!updateMUAMeeting">
                            <div class="form-group">
                                <label>ID：</label>
                                <input id="cell2" type="text" class="form-control" name="AcaMeetingID"><span
                                    class="help-block m-b-none">请输入ID</span>
                            </div>
                            <div class="form-group">
                                <label>会议名称</label>
                                <input id="cell3" type="text" class="form-control" name="AcaMeetingName" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>负责人</label>
                            ...
                            <div class="form-group">
                                <label>会议类别：</label>
                                <select id="cell5" class="form-control m-b" name="AcaMeetType">
                                    <%
                                        if (d != null) {
                                            for (int i = 0; i < d.size(); i++) {
                                    %>
                            ...
                            <div class="form-group">
                                <label>会议地点：</label>
                                <select id="cell6" class="form-control m-b" name="AcaMeetPlace">
                                    <%
                                        if (b != null) {
                                            for (int i = 0; i < b.size(); i++) {
                                    %>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <form role="form" id="onlyForm" action="AddMUAMeeting!updateTandMUAMeeting">
                            ...
                            <div class="form-group">
                                <label>ID：</label>
                                <input id="num2" type="text" class="form-control" name="AcaMeetingID"><span
                                    class="help-block m-b-none">请输入ID</span>
                            </div>
                            <div class="form-group">
                                <label>本人承担的任务：</label>
        ...
        <script>
            function dodelX(delid) {
                swal({
                    ...
                    document.f.action = "AddMUAMeeting!delMUAMeeting?AcaMeetingID=" + delid;
                    f.submit();
                });
            ...
            function dodelJ(delid, teacherid) {
                swal({
                    ...
                    document.f.action = "AddMUAMeeting!delTandMUAMeeting?AcaMeetingID=" + delid + "&TeacherID=" + teacherid;
                    f.submit();
                });
            }
        </script>
