...
<div class="datepick">
    <span>选择日期范围</span>
    <div>
        <form action="ATva_newactapplyManage!getWorkall?pagenum=1" method="post" name="pickdate" id="pickdates">
...
<!--                                     <tbody> -->
                                    <c:forEach var="entity" items="${List }">
                                        <tr>
											...
											<c:if test="${entity.actType==1 }"><td>规定性活动</td></c:if>
											<c:if test="${entity.actType==2 }"><td>选择性活动</td></c:if>
											<c:if test="${entity.actType==3 }"><td>其他活动</td></c:if>
											<td>${fn:substring(entity.actapplyfile,0,8)  }……
<!-- 													<button class="button_set"  -->
<!-- 													data-toggle="modal" -->
...
<!--                                                     <a href="" class="btn btn-primary btn-sm delwords delinf update"  data-toggle="modal" data-target="#update">修改</a> -->
                                                    <a class="btn btn-primary btn-sm delwords delinf1" data-toggle="modal">删除</a>
                                                </c:if>
                                                <c:if test="${entity.aspareTire == '1' }">
                                                    <a href="" class="btn btn-primary btn-sm delwords delinf update"  data-toggle="modal" data-target="#update">修改</a>
                                                    <a class="btn btn-primary btn-sm delwords delinf1" data-toggle="modal">删除</a>
                                                </c:if>
                                            </td>
...
<!--                                     </tbody> -->
                            ...
                            <div style="text-align: center;">
                                (共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
                            	    第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
                                <a class="comphref" href="ATva_newactapplyManage!getWorkall?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
                                <a class="comphref" href="ATva_newactapplyManage!getWorkall?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
                                <a class="comphref" href="ATva_newactapplyManage!getWorkall?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
                                <a class="comphref" href="ATva_newactapplyManage!getWorkall?pagenum=${sumpage }">尾页</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <form role="form" name="actupdate" id="updateInfoForm" action="" method="post">
                                <div class="form-group">
                                    <label for="" >活动申请编号</label>&nbsp;<label for=""></label>
                                    <input type="text" id="actapplyNo" class="form-control doCheck_update" name="actapplynumber">
                                </div>
                                <div class="form-group">
                                    <label for="" >活动名称</label>&nbsp;<label for=""></label>
                                    <input type="text" id="actapplyName" class="form-control doCheck_update" name="actapplyname">
                                </div>
                                <div class="form-group">
                                    <label for="" >活动类型</label>&nbsp;<label for=""></label>
                                    <select id="actapplyType" class="form-control"
										name="actapplytype">
                                ...
                                <div class="form-group">
                                    <label for="" >活动分数</label>&nbsp;<label for=""></label>
                                    <input type="text" id="actapplyScore" class="form-control doCheck_update" name="actapplyscore">
                                </div>
<!--                                 <div class="form-group"> -->
