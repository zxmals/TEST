        ...
        <div style="width: auto">
            <div class="actmana">
                <div id="inact">
                    ...
                    <span id="span3" onmousedown="change_s('span3')" onmouseup="recoberstyle('span3','../VA/add_unjoinreason_act.jsp')" title="未补充将对此次规定性公益活动的绩效分-累计对应的负分"><a target="ifm" href="../VA/add_unjoinreason_act.jsp">补充未参加的规定性活动的原因</a></span>
                </div>
            </div>
            <div class="framework">
                <div id="ifk">
