        ...
        <div style="width: auto">
            <div class="actmana">
                <div id="inact">
                    ...
                    <span id="span3" onmousedown="change_s('span3')" onmouseup="recoberstyle('span3','../VA/add_unjoinreasonAct.jsp')" title="未补充将对此次规定性公益活动的绩效分-累计对应的负分"><a target="ifm" href="../VA/add_unjoinreasonAct.jsp">未参与的规定性公益活动</a></span><br>
                    <span id="span4" onmousedown="change_s('span4')" onmouseup="recoberstyle('span4','GTapply_actpublish!getReadyAct')" title="申请发布一项活动"><a target="ifm" href="GTapply_actpublish!getReadyAct">发布活动</a></span><br>
                    <span id="span5" onmousedown="change_s('span5')" onmouseup="recoberstyle('span5','GTadd_applay_act')" title="申请新增一项公益活动"><a target="ifm" href="GTadd_applay_act">申请新增公益活动</a></span>
                </div>
            </div>
            <div class="framework">
                <div id="ifk">
