...
<body class="gray-bg"  onload="DoCheck()">
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <br>
	                    <form id="adjusts" action="ATteachingpaperPerformanceSet!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingpaperPerformanceSet!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingpaperPerformanceSet!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingpaperPerformanceSet!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingpaperPerformanceSet!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
    	...
    	if(checkadds()&&projectId!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("ATteachingpaperPerformanceSet!updateProject",
    	    							{"teachpaperproject.teachPaperId":projectId,
    	    							 "teachpaperproject.teachPaperName":$('#gainName').val().trim(),
    	    							 "teachpaperproject.chargePersonId":chargePersonId,
    	    	    					...
    	    	    					function(data,status){
    	    	    						if(status=="success"){
    	    	    							 if(data=="succ"){
    	    	    								 swal("更新成功","","success");
    	    	    								 setTimeout(function() {
    	    	    									 window.location.replace("ATteachingpaperPerformanceSet!gainAllProject?pagenum=1");
    	    										}, 2000);
    	    	    							 }else{
    	    	    								 swal("失败","","error");
    	    	    							 }
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("ATteachingpaperPerformanceSet!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		chargePersonId = row[0].cells[6].innerHTML.trim();
		$.post("ATteachingpaperPerformanceSet!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("ATteachingpaperPerformanceSet!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "teachpaperproject.teachPaperId":projectId},
		function(data,status){
        			...
        			function(isConfirm){   
        				if (isConfirm&projectId!="") {
        					if(chargePersonId.trim()!=row[0].cells[0].innerHTML.trim()){
	        					$.post("ATteachingpaperPerformanceSet!quitProject",
										{"teachpaperproject.teachPaperId":projectId,
