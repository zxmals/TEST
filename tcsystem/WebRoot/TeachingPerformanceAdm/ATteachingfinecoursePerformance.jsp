...
<body class="gray-bg"  onload="DoCheck()">
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <br>
	                    <form id="adjusts" action="ATteachingfinecoursePerformanceSet!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfinecoursePerformanceSet!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfinecoursePerformanceSet!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfinecoursePerformanceSet!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfinecoursePerformanceSet!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
    	...
    	if(checkadds()&&projectId!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("ATteachingfinecoursePerformanceSet!updateProject",
    	    							{"finecourseproject.courseId":projectId,
	    	    						 "finecourseproject.courseName":$('#gainName').val().trim(),
	    	    						 "finecourseproject.chargePersonId":chargePersonId,
    	    	    					...
    	    	    					function(data,status){
    	    	    						if(status=="success"){
    	    	    							 if(data=="succ"){
    	    	    								 swal("更新成功","","success");
    	    	    								 setTimeout(function() {
    	    	    									 window.location.replace("ATteachingfinecoursePerformanceSet!gainAllProject?pagenum=1");
    	    										}, 2000);
    	    	    							 }else{
    	    	    								 swal("失败","","error");
    	    	    							 }
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("ATteachingfinecoursePerformanceSet!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		chargePersonId = row[0].cells[6].innerHTML.trim();
		$.post("ATteachingfinecoursePerformanceSet!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("ATteachingfinecoursePerformanceSet!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "finecourseproject.courseId":projectId},
		function(data,status){
    ...
    $(document).click(function(e) {
    	if(e.target.className.indexOf("deletemember")>=0){
    		...
    		var x = confirm("确定移除该项目负责人？？？");
       		if (x&projectId!="") {
      			if(chargePersonId==row[0].cells[0].innerHTML.trim()){
        			swal("ERROR","不能移除项目负责人","error");
        		}else{
        			alert(chargePersonId+"&&"+row[0].cells[0].innerHTML.trim());
	      			$.post("ATteachingfinecoursePerformanceSet!quitProject",
							   {"finecourseproject.courseId":projectId,
