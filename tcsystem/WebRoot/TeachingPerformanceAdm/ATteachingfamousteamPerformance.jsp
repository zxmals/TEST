	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <br>
	                    <form id="adjusts" action="ATteachingfamousteamPerformanceSet!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfamousteamPerformanceSet!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfamousteamPerformanceSet!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfamousteamPerformanceSet!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingfamousteamPerformanceSet!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
    	...
    	if(checkadds()&&projectId!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("ATteachingfamousteamPerformanceSet!updateTeachTeam",
...
// 	    	    						 "teachteamprojec.projectSumScore":$('#projectSumScore').val().trim(),
		    							 ...
		    							 "teachteamprojec.chargePersonId":chargePersonId,
    	    	    					...
    	    	    					function(data,status){
    	    	    						if(status=="success"){
    	    	    							 if(data=="succ"){
    	    	    								 swal("更新成功","","success");
    	    	    								 setTimeout(function() {
    	    	    									 window.location.replace("ATteachingfamousteamPerformanceSet!gainAllProject?pagenum=1");
    	    										}, 2000);
    	    	    							 }else{
    	    	    								 swal("失败","","error");
    	    	    							 }
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("ATteachingfamousteamPerformanceSet!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		chargePersonId = row[0].cells[5].innerHTML.trim();
		$.post("ATteachingfamousteamPerformanceSet!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("ATteachingfamousteamPerformanceSet!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "teachteamprojec.teacherTeamPerformanceId":projectId},
		function(data,status){
        			...
        			function(isConfirm){   
        				if (isConfirm&projectId!="") {
        					if(chargePersonId.trim()!=row[0].cells[0].innerHTML.trim()){
	        					$.post("ATteachingfamousteamPerformanceSet!quitProject",
										{"teachteamprojec.teacherTeamPerformanceId":projectId,
