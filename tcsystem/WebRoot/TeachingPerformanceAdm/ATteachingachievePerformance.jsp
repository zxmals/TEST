...
<body class="gray-bg"  onload="DoCheck()">
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content" style="height:540px;">
	                    	 <br>
	                    <form id="adjusts" action="ATteachingachievePerformanceSet!gainAllProject" method="get">
							<div>
			                    	<a>每页   
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingachievePerformanceSet!gainAllProject?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingachievePerformanceSet!gainAllProject?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingachievePerformanceSet!gainAllProject?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATteachingachievePerformanceSet!gainAllProject?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
    	...
    	if(checkadds()&&projectId!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("ATteachingachievePerformanceSet!updateProject",
    	    							{"achieveproject.projectId":projectId,
	    	    						 "achieveproject.projectName":$('#gainName').val().trim(),
	    	    						 "achieveproject.chargePersonId":chargePersonId,
    	    	    					...
    	    	    					function(data,status){
    	    	    						if(status=="success"){
    	    	    							 if(data=="succ"){
    	    	    								 swal("更新成功","","success");
    	    	    								 setTimeout(function() {
    	    	    									 window.location.replace("ATteachingachievePerformanceSet!gainAllProject?pagenum=1");
    	    										}, 2000);
    	    	    							 }else{
    	    	    								 swal("失败","","error");
    	    	    							 }
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("ATteachingachievePerformanceSet!deleteProject",
    ...
    $('.getMember').click(function() {
		...
		chargePersonId = row[0].cells[6].innerHTML.trim();
		$.post("ATteachingachievePerformanceSet!getMember",
    ...
    $('#subchangescore').click(function() {
		...
		$.post("ATteachingachievePerformanceSet!changescore",
				{"mixs":jobj,
				 "sumscore":sumscore,
				 "achieveproject.projectId":projectId},
		function(data,status){
        			...
        			function(isConfirm){   
        				if (isConfirm&projectId!="") {
        					if(chargePersonId.trim()!=row[0].cells[0].innerHTML.trim()){
	        					$.post("ATteachingachievePerformanceSet!quitProject",
										{"achieveproject.projectId":projectId,
