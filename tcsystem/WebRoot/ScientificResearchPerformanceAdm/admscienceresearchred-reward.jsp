...
<body class="gray-bg"  onload="DoCheck()">
	<div class="datepick">
		<span>选择日期范围</span>
		<div>
			<form action="ATscienceresearchred-rewardset!gainscienceReward?pagenum=1" method="post" name="pickdate" id="pickdates">
	                    ...
	                    <br>
	                       ...
	                       <table  id="tb" class="table table-striped table-bordered table-hover dataTables-example">
	                        ...
	                        <div style="text-align: center;">
	                        	(共查询到${sumrow }条记录)&nbsp;&nbsp;&nbsp;&nbsp;
	                        	第${pagenum }/${sumpage }页&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATscienceresearchred-rewardset!gainscienceReward?pagenum=1">首页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATscienceresearchred-rewardset!gainscienceReward?pagenum=${prepage }">上一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATscienceresearchred-rewardset!gainscienceReward?pagenum=${nextpage }">下一页</a>&nbsp;&nbsp;&nbsp;
	                        	<a class="comphref" href="ATscienceresearchred-rewardset!gainscienceReward?pagenum=${sumpage }">尾页</a>
	                        </div>
	                   </div>
	                </div>
	            </div>
    ...
    $('#changelength').change(function() {
		...
		window.location.replace("ATscienceresearchred-rewardset!gainscienceReward?pagenum=1&limit="+$(this).val().trim()+"&foredate="+$('#date1').val().trim()+"&afterdate="+$('#date2').val().trim());
	});
    </script>
    <!-- update  -->
    <script>
    	...
    	if(checkadds()&&scienRID!=""){	
    			swal({   
    	    		...
    	    		closeOnCancel: true }, 
    	    			function(isConfirm){   
    	    				if (isConfirm) {
    	    					$.post("ATscienceresearchred-rewardset!updateScienceRwared",
    	    							{"scienceReward.srrewardId":$('#scienrewardId').val().trim(),
		    							 ...
		    							 "scienceReward.chargePersonId":chargePersonIds,
    	    	    					...
    	    	    					function(data,status){
    	    	    						if(status=="success"){
    	    	    							 if(data=="succ"){
    	    	    								 swal("更新成功","","success");
    	    	    								 setTimeout(function() {
    	    	    									 window.location.replace("ATscienceresearchred-rewardset!gainscienceReward?pagenum=1");
    	    										}, 2000);
    	    	    							 }else{
    	    	    								 swal("失败",data,"error");
    	    	    							 }
    ...
    $('#subdel').click(function() {
    	swal({   
    		...
    		closeOnCancel: true }, 
    			function(isConfirm){   
    				if (isConfirm) {
    					$.post("ATscienceresearchred-rewardset!deleteScienceReward",
    							{"scienceReward.srrewardId":$('#scienrewardId').val().trim()},
    							function(data,status){
    								if(status=="success"){
    									if(data=="succ"){
    ...
    $('.getMember').click(function() {
		var row = $(this).parent().parent();
		$.post("ATscienceresearchred-rewardset!getMember",
        		...
        		closeOnCancel: true }, 
        			function(isConfirm){   
        				if (isConfirm&pubsprojectId!="") {
        					$.post("ATscienceresearchred-rewardset!deleteMember",
        							{"scienceReward.srrewardId":pubsprojectId,
